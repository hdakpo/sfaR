...
LCM3ChnormAlgOpt <- function(start, olsParam, dataTable, S, wHvar,
  ...
  mleObj <- switch(method, ucminf = ucminf(par = startVal,
    ...
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar),
    sr1 = trust.optim(x = startVal, fn = function(parm) -sum(cLCMhalfnormlike3C(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)),
...
cLCM3Chalfnormeff <- function(object, level) {
  ...
  if (object$logDepVar == TRUE) {
    ...
    res <- bind_cols(Group_c = Group_c, PosteriorProb_c = P_cond_c,
      ...
      PriorProb_c2 = Probc2, PriorProb_c3 = Probc3, u_c = u_c,
      teJLMS_c = teJLMS_c, u_c1 = u_c1, u_c2 = u_c2, u_c3 = u_c3,
    ...
    res <- bind_cols(Group_c = Group_c, PosteriorProb_c = P_cond_c,
      ...
      PosteriorProb_c3 = Pcond_c3, PriorProb_c1 = Probc1,
      PriorProb_c2 = Probc2, PriorProb_c3 = Probc3, u_c = u_c,
      u_c1 = u_c1, u_c2 = u_c2, u_c3 = u_c3, ineff_c1 = ineff_c1,
      ineff_c2 = ineff_c2, ineff_c3 = ineff_c3)
  }
  return(res)
}
