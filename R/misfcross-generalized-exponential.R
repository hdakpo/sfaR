...
misfgenexponormAlgOpt_logit <- function(start, olsParam, dataTable,
  ...
  mleObj <- switch(method, ucminf = ucminf::ucminf(par = startVal,
    ...
    maxLikAlgo = maxRoutine(fn = cmisfgenexponormlike_logit,
      ...
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar),
    sr1 = trustOptim::trust.optim(x = startVal, fn = function(parm) -sum(cmisfgenexponormlike_logit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)),
      gr = function(parm) -colSums(cgradmisfgenexponormlike_logit(parm,
...
misfgenexponormAlgOpt_cauchit <- function(start, olsParam, dataTable,
  ...
  mleObj <- switch(method, ucminf = ucminf::ucminf(par = startVal,
    ...
    maxLikAlgo = maxRoutine(fn = cmisfgenexponormlike_cauchit,
      ...
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar),
    sr1 = trustOptim::trust.optim(x = startVal, fn = function(parm) -sum(cmisfgenexponormlike_cauchit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)),
      gr = function(parm) -colSums(cgradmisfgenexponormlike_cauchit(parm,
...
misfgenexponormAlgOpt_probit <- function(start, olsParam, dataTable,
  ...
  mleObj <- switch(method, ucminf = ucminf::ucminf(par = startVal,
    ...
    maxLikAlgo = maxRoutine(fn = cmisfgenexponormlike_probit,
      ...
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar),
    sr1 = trustOptim::trust.optim(x = startVal, fn = function(parm) -sum(cmisfgenexponormlike_probit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)),
      gr = function(parm) -colSums(cgradmisfgenexponormlike_probit(parm,
...
misfgenexponormAlgOpt_cloglog <- function(start, olsParam, dataTable,
  ...
  mleObj <- switch(method, ucminf = ucminf::ucminf(par = startVal,
    ...
    maxLikAlgo = maxRoutine(fn = cmisfgenexponormlike_cloglog,
      ...
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar),
    sr1 = trustOptim::trust.optim(x = startVal, fn = function(parm) -sum(cmisfgenexponormlike_cloglog(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)),
      gr = function(parm) -colSums(cgradmisfgenexponormlike_cloglog(parm,
