...
#' @noRd
cLCMhalfnormlike5C <- function(parm, nXvar, nuZUvar, nvZVvar, uHvar, vHvar, Yvar,
  ...
  Pi5 <- 2/sqrt(exp(Wu5) + exp(Wv5)) * dnorm(S * epsilon5/sqrt(exp(Wu5) + exp(Wv5))) *
    pnorm(mustar5/sigmastar5)
...
#' @noRd
csLCMfhalfnorm5C <- function(olsObj, epsiRes, nXvar, nuZUvar, nvZVvar, uHvar, vHvar,
  ...
  StartVal <- c(Esti[1:(nXvar + 1)], if (nuZUvar > 1) rep(0, nuZUvar - 1), Esti[nXvar +
    ...
    Esti[nXvar + 1], if (nuZUvar > 1) rep(0, nuZUvar - 1), Esti[nXvar + 2], if (nvZVvar >
      1) rep(0, nvZVvar - 1), rep(0, 4 * nZHvar))
  names(StartVal) <- c(names(Esti)[1:nXvar], paste0("Zu_", colnames(uHvar)), paste0("Zv_",
    ...
    colnames(vHvar)), names(Esti)[1:nXvar], paste0("Zu_", colnames(uHvar)), paste0("Zv_",
    colnames(vHvar)), names(Esti)[1:nXvar], paste0("Zu_", colnames(uHvar)), paste0("Zv_",
    colnames(vHvar)), paste0("Cl1_", colnames(Zvar)), paste0("Cl2_", colnames(Zvar)),
    paste0("Cl3_", colnames(Zvar)), paste0("Cl4_", colnames(Zvar)))
...
#' @param nZHvar number of separating variables
#' @noRd
cgradLCMhalfnormlike5C <- function(parm, nXvar, nuZUvar, nvZVvar, uHvar, vHvar, Yvar,
  Xvar, S, wHvar, Zvar, nZHvar) {
  beta1 <- parm[1:(nXvar)]
  delta1 <- parm[(nXvar + 1):(nXvar + nuZUvar)]
  phi1 <- parm[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar)]
  ...
  sigx1_1 <- (dmusig1 * depsisq1 * ewu1/sigmastar1 + S * depsisq1 * pmusig1 * (epsilon1))
  sigx1_2 <- (dmusig2 * depsisq2 * ewu2/sigmastar2 + S * depsisq2 * pmusig2 * (epsilon2))
  sigx1_3 <- (dmusig3 * depsisq3 * ewu3/sigmastar3 + S * depsisq3 * pmusig3 * (epsilon3))
  sigx1_4 <- (dmusig4 * depsisq4 * ewu4/sigmastar4 + S * depsisq4 * pmusig4 * (epsilon4))
  sigx1_5 <- (dmusig5 * depsisq5 * ewu5/sigmastar5 + S * depsisq5 * pmusig5 * (epsilon5))
  ...
  sigx2_1 <- (0.5 * ((1 - ewu1/(sigma_sq1)) * ewv1/sigmastar1) + sigmastar1)
  sigx2_2 <- (0.5 * ((1 - ewu2/(sigma_sq2)) * ewv2/sigmastar2) + sigmastar2)
  sigx2_3 <- (0.5 * ((1 - ewu3/(sigma_sq3)) * ewv3/sigmastar3) + sigmastar3)
  sigx2_4 <- (0.5 * ((1 - ewu4/(sigma_sq4)) * ewv4/sigmastar4) + sigmastar4)
  sigx2_5 <- (0.5 * ((1 - ewu5/(sigma_sq5)) * ewv5/sigmastar5) + sigmastar5)
  sigx3_1 <- (0.5 * ((1 - ewv1/(sigma_sq1)) * ewu1/sigmastar1) + sigmastar1)
  sigx3_2 <- (0.5 * ((1 - ewv2/(sigma_sq2)) * ewu2/sigmastar2) + sigmastar2)
  sigx3_3 <- (0.5 * ((1 - ewv3/(sigma_sq3)) * ewu3/sigmastar3) + sigmastar3)
  sigx3_4 <- (0.5 * ((1 - ewv4/(sigma_sq4)) * ewu4/sigmastar4) + sigmastar4)
  sigx3_5 <- (0.5 * ((1 - ewv5/(sigma_sq5)) * ewu5/sigmastar5) + sigmastar5)
  ...
  sigx4 <- ((2 * wzlogit1 + 2 * wzlogit2 + 2 * wzlogit3 + 2 * wzlogit4)/wzdeno +
    2 * wzlogit5)
  ...
  sigx6_1 <- (S * (dpepsisq1 - sqewu1 * dmusig1 * depsisq1) * (epsilon1) - sigx5_1)
  sigx6_2 <- (S * (dpepsisq2 - sqewu2 * dmusig2 * depsisq2) * (epsilon2) - sigx5_2)
  sigx6_3 <- (S * (dpepsisq3 - sqewu3 * dmusig3 * depsisq3) * (epsilon3) - sigx5_3)
  sigx6_4 <- (S * (dpepsisq4 - sqewu4 * dmusig4 * depsisq4) * (epsilon4) - sigx5_4)
  sigx6_5 <- (S * (dpepsisq5 - sqewu5 * dmusig5 * depsisq5) * (epsilon5) - 0.5 *
    dpsq5)
  sigx7_1 <- (S * (sigx3_1 * dmusig1 * depsisq1 * ewu1/sqsq1^2 + dpepsisq1) * (epsilon1) -
    sigx5_1)
  sigx7_2 <- (S * (sigx3_2 * dmusig2 * depsisq2 * ewu2/sqsq2^2 + dpepsisq2) * (epsilon2) -
    sigx5_2)
  sigx7_3 <- (S * (sigx3_3 * dmusig3 * depsisq3 * ewu3/sqsq3^2 + dpepsisq3) * (epsilon3) -
    sigx5_3)
  sigx7_4 <- (S * (sigx3_4 * dmusig4 * depsisq4 * ewu4/sqsq4^2 + dpepsisq4) * (epsilon4) -
    sigx5_4)
  sigx7_5 <- (S * (sigx3_5 * dmusig5 * depsisq5 * ewu5/sqsq5^2 + dpepsisq5) * (epsilon5) -
    0.5 * dpsq5)
  gradll <- cbind(sweep(Xvar, MARGIN = 1, STATS = 2 * (S * sigx1_1 * ewz1/sigsq_1),
    FUN = "*"), sweep(uHvar, MARGIN = 1, STATS = 2 * (ewu1 * ewz1 * sigx6_1/(sigwz1)),
    FUN = "*"), sweep(vHvar, MARGIN = 1, STATS = 2 * (ewv1 * ewz1 * sigx7_1/(sigwz1)),
    FUN = "*"), sweep(Xvar, MARGIN = 1, STATS = 2 * (S * sigx1_2 * ewz2/sigsq_2),
    FUN = "*"), sweep(uHvar, MARGIN = 1, STATS = 2 * (ewu2 * ewz2 * sigx6_2/(sigwz2)),
    FUN = "*"), sweep(vHvar, MARGIN = 1, STATS = 2 * (ewv2 * ewz2 * sigx7_2/(sigwz2)),
    FUN = "*"), sweep(Xvar, MARGIN = 1, STATS = 2 * (S * sigx1_3 * ewz3/sigsq_3),
    FUN = "*"), sweep(uHvar, MARGIN = 1, STATS = 2 * (ewu3 * ewz3 * sigx6_3/(sigwz3)),
    FUN = "*"), sweep(vHvar, MARGIN = 1, STATS = 2 * (ewv3 * ewz3 * sigx7_3/(sigwz3)),
    FUN = "*"), sweep(Xvar, MARGIN = 1, STATS = 2 * (S * sigx1_4 * ewz4/sigsq_4),
    FUN = "*"), sweep(uHvar, MARGIN = 1, STATS = 2 * (ewu4 * ewz4 * sigx6_4/(sigwz4)),
    FUN = "*"), sweep(vHvar, MARGIN = 1, STATS = 2 * (ewv4 * ewz4 * sigx7_4/(sigwz4)),
    FUN = "*"), sweep(Xvar, MARGIN = 1, STATS = 2 * (S * prC * sigx1_5/sigsq_5),
    FUN = "*"), sweep(uHvar, MARGIN = 1, STATS = 2 * (prC * ewu5 * sigx6_5/(sigwz5)),
    FUN = "*"), sweep(vHvar, MARGIN = 1, STATS = 2 * (prC * ewv5 * sigx7_5/(sigwz5)),
    FUN = "*"), sweep(Zvar, MARGIN = 1, STATS = (2 * dpsq1 - sigx4) * ewz1/wzdsig,
    FUN = "*"), sweep(Zvar, MARGIN = 1, STATS = (2 * dpsq2 - sigx4) * ewz2/wzdsig,
    FUN = "*"), sweep(Zvar, MARGIN = 1, STATS = (2 * dpsq3 - sigx4) * ewz3/wzdsig,
    FUN = "*"), sweep(Zvar, MARGIN = 1, STATS = (2 * dpsq4 - sigx4) * ewz4/wzdsig,
    FUN = "*"))
...
#' @param nZHvar number of separating variables
#' @noRd
chessLCMhalfnormlike5C <- function(parm, nXvar, nuZUvar, nvZVvar, uHvar, vHvar, Yvar,
  Xvar, S, wHvar, Zvar, nZHvar) {
  beta1 <- parm[1:(nXvar)]
  delta1 <- parm[(nXvar + 1):(nXvar + nuZUvar)]
  phi1 <- parm[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar)]
  ...
  wzlx4 <- (2 * wzlogit1 + 2 * wzlogit2 + 2 * wzlogit3 + 2 * wzlogit4)/wzdeno
  ...
  sigx10_1 <- (0.5 * (S * (dmusig1 * ewu1/sigmastar1 + S * pmusig1 * (epsilon1)) *
    (epsilon1)/(sigma_sq1) - pmusig1) - 0.5 * pmusig1) * dep1sq1
  sigx10_2 <- (0.5 * (S * (dmusig2 * ewu2/sigmastar2 + S * pmusig2 * (epsilon2)) *
    (epsilon2)/(sigma_sq2) - pmusig2) - 0.5 * pmusig2) * dep1sq2
  sigx10_3 <- (0.5 * (S * (dmusig3 * ewu3/sigmastar3 + S * pmusig3 * (epsilon3)) *
    (epsilon3)/(sigma_sq3) - pmusig3) - 0.5 * pmusig3) * dep1sq3
  sigx10_4 <- (0.5 * (S * (dmusig4 * ewu4/sigmastar4 + S * pmusig4 * (epsilon4)) *
    (epsilon4)/(sigma_sq4) - pmusig4) - 0.5 * pmusig4) * dep1sq4
  sigx10_5 <- (0.5 * (S * (dmusig5 * ewu5/sigmastar5 + S * pmusig5 * (epsilon5)) *
    (epsilon5)/(sigma_sq5) - pmusig5) - 0.5 * pmusig5) * dep1sq5
  ...
  sigx13_1 <- (S * (sigx3_1 * dmusig1 * depsisq1 * ewu1/sqsq1^2 + dpepsisq1) *
    (epsilon1) - depsisq1 * pmusig1/(sigma_sq1))
  sigx13_2 <- (S * (sigx3_2 * dmusig2 * depsisq2 * ewu2/sqsq2^2 + dpepsisq2) *
    (epsilon2) - depsisq2 * pmusig2/(sigma_sq2))
  sigx13_3 <- (S * (sigx3_3 * dmusig3 * depsisq3 * ewu3/sqsq3^2 + dpepsisq3) *
    (epsilon3) - depsisq3 * pmusig3/(sigma_sq3))
  sigx13_4 <- (S * (sigx3_4 * dmusig4 * depsisq4 * ewu4/sqsq4^2 + dpepsisq4) *
    (epsilon4) - depsisq4 * pmusig4/(sigma_sq4))
  sigx13_5 <- (S * (sigx3_5 * dmusig5 * depsisq5 * ewu5/sqsq5^2 + dpepsisq5) *
    (epsilon5) - depsisq5 * pmusig5/(sigma_sq5))
  ...
  sigx4w5z <- ((2 - 2 * (ewz1/wzdeno))/wzdsig - 2 * ((2 * dpsq1 - sigx4) * ewz1/wzdsig^2))
  sigx4w6z <- ((2 - 2 * (ewz2/wzdeno))/wzdsig - 2 * ((2 * dpsq2 - sigx4) * ewz2/wzdsig^2))
  sigx4w7z <- ((2 - 2 * (ewz3/wzdeno))/wzdsig - 2 * ((2 * dpsq3 - sigx4) * ewz3/wzdsig^2))
  sigx4w8z <- ((2 - 2 * (ewz4/wzdeno))/wzdsig - 2 * ((2 * dpsq4 - sigx4) * ewz4/wzdsig^2))
  ...
  sigx4w13z <- (0.5 * (sigx4/sqrt(sigma_sq5)) + 2 * (prC * sigx6_5))
  ...
  sigx15_1 <- (S * depsisq1 * (S * sigx14_1 * (epsilon1) - 2 * (pmusig1/(sigma_sq1))) *
    (epsilon1)/(sigma_sq1)^2)
  sigx15_2 <- (S * depsisq2 * (S * sigx14_2 * (epsilon2) - 2 * (pmusig2/(sigma_sq2))) *
    (epsilon2)/(sigma_sq2)^2)
  sigx15_3 <- (S * depsisq3 * (S * sigx14_3 * (epsilon3) - 2 * (pmusig3/(sigma_sq3))) *
    (epsilon3)/(sigma_sq3)^2)
  sigx15_4 <- (S * depsisq4 * (S * sigx14_4 * (epsilon4) - 2 * (pmusig4/(sigma_sq4))) *
    (epsilon4)/(sigma_sq4)^2)
  sigx15_5 <- (S * depsisq5 * (S * sigx14_5 * (epsilon5) - 2 * (pmusig5/(sigma_sq5))) *
    (epsilon5)/(sigma_sq5)^2)
  ...
  hessll[1:nXvar, 1:nXvar] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = 2 * (S^2 *
    ((depsisq1 * (S * (dmusig1 * ewu1/sigmastar1 + S * pmusig1 * (epsilon1)) *
      (epsilon1)/(sigma_sq1) - pmusig1) + S * dmusig1 * (duv1) * ewu1 * (epsilon1)/sqsq1)/sigsq_1 -
      2 * (sigx1_1^2 * ewz1/sigsq_1^2)) * ewz1) * wHvar, FUN = "*"), Xvar)
  hessll[1:nXvar, (nXvar + 1):(nXvar + nuZUvar)] <- crossprod(sweep(Xvar, MARGIN = 1,
    STATS = 2 * (S * ((sqewu1 * dmusig1 * depsisq1 + (S * (sigx10_1 - S * sqewu1 *
      dmusig1 * (duv1) * (epsilon1)) * (epsilon1) - 0.5 * (sigx1_1/(sigma_sq1)))/(sigma_sq1))/(sigwz1) -
      2 * (sigx1_1 * ewz1 * sigx6_1/((sigwz1)^2 * (sigma_sq1)))) * ewu1 * ewz1) *
      wHvar, FUN = "*"), uHvar)
  hessll[1:nXvar, (nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = 2 * (S * (((S * (sigx10_1 + S * sigx3_1 * dmusig1 * (duv1) *
      ewu1 * (epsilon1)/sqsq1^2) * (epsilon1) - 0.5 * (sigx1_1/(sigma_sq1)))/(sigma_sq1) -
      sigx3_1 * dmusig1 * depsisq1 * ewu1/sqsq1^2)/(sigwz1) - 2 * (sigx1_1 *
      ewz1 * sigx7_1/((sigwz1)^2 * (sigma_sq1)))) * ewv1 * ewz1) * wHvar, FUN = "*"),
    vHvar)
  hessll[1:nXvar, (nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = -(4 * (S^2 * sigx1_1 * sigx1_2 * (sigma_sq2) * ewz1 *
      ewz2 * sqrt(sigma_sq2)/(sigsq_2^2 * (sigma_sq1)^(3/2)))) * wHvar, FUN = "*"),
    Xvar)
  hessll[1:nXvar, (2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar +
    nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 * (S * sigx1_1 *
    ewu2 * ewz1 * ewz2 * sigx6_2 * sqrt(sigma_sq2)/((sigwz2)^2 * (sigma_sq1)^(3/2)))) *
    wHvar, FUN = "*"), uHvar)
  hessll[1:nXvar, (2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar +
    2 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 * (S * sigx1_1 *
    ewv2 * ewz1 * ewz2 * sigx7_2 * sqrt(sigma_sq2)/((sigwz2)^2 * (sigma_sq1)^(3/2)))) *
    wHvar, FUN = "*"), vHvar)
  hessll[1:nXvar, (2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 2 *
    nuZUvar + 2 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S^2 * sigx1_1 * sigx1_3 * (sigma_sq3) * ewz1 * ewz3 * sqrt(sigma_sq3)/(sigsq_3^2 *
      (sigma_sq1)^(3/2)))) * wHvar, FUN = "*"), Xvar)
  hessll[1:nXvar, (3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 *
    nuZUvar + 2 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S * sigx1_1 * ewu3 * ewz1 * ewz3 * sigx6_3 * sqrt(sigma_sq3)/((sigwz3)^2 *
      (sigma_sq1)^(3/2)))) * wHvar, FUN = "*"), uHvar)
  hessll[1:nXvar, (3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 *
    nuZUvar + 3 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S * sigx1_1 * ewv3 * ewz1 * ewz3 * sigx7_3 * sqrt(sigma_sq3)/((sigwz3)^2 *
      (sigma_sq1)^(3/2)))) * wHvar, FUN = "*"), vHvar)
  hessll[1:nXvar, (3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 *
    nuZUvar + 3 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S^2 * sigx1_1 * sigx1_4 * (sigma_sq4) * ewz1 * ewz4 * sqrt(sigma_sq4)/(sigsq_4^2 *
      (sigma_sq1)^(3/2)))) * wHvar, FUN = "*"), Xvar)
  hessll[1:nXvar, (4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 *
    nuZUvar + 3 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S * sigx1_1 * ewu4 * ewz1 * ewz4 * sigx6_4 * sqrt(sigma_sq4)/((sigwz4)^2 *
      (sigma_sq1)^(3/2)))) * wHvar, FUN = "*"), uHvar)
  hessll[1:nXvar, (4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S * sigx1_1 * ewv4 * ewz1 * ewz4 * sigx7_4 * sqrt(sigma_sq4)/((sigwz4)^2 *
      (sigma_sq1)^(3/2)))) * wHvar, FUN = "*"), vHvar)
  hessll[1:nXvar, (4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S^2 * prC * sigx1_1 * sigx1_5 * (sigma_sq5) * ewz1 * sqrt(sigma_sq5)/(wzc1 *
      (sigma_sq1)^(3/2)))) * wHvar, FUN = "*"), Xvar)
  hessll[1:nXvar, (5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S * prC * sigx1_1 * ewu5 * ewz1 * sigx6_5 * sqrt(sigma_sq5)/wzsigx4_1)) *
    wHvar, FUN = "*"), uHvar)
  hessll[1:nXvar, (5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S * prC * sigx1_1 * ewv5 * ewz1 * sigx7_5 * sqrt(sigma_sq5)/wzsigx4_1)) *
    wHvar, FUN = "*"), vHvar)
  hessll[1:nXvar, (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar + nZHvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = S *
    sigx4w5z * sigx1_1 * ewz1/((sigma_sq1)^(3/2)) * wHvar, FUN = "*"), Zvar)
  hessll[1:nXvar, (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(Xvar, MARGIN = 1,
    STATS = -(S * sigx4w2z * sigx1_1 * ewz1 * ewz2/((sigma_sq1)^(3/2))) * wHvar,
    FUN = "*"), Zvar)
  hessll[1:nXvar, (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = -(S * sigx4w3z * sigx1_1 * ewz1 * ewz3/((sigma_sq1)^(3/2))) *
      wHvar, FUN = "*"), Zvar)
  hessll[1:nXvar, (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = -(S * sigx4w4z * sigx1_1 * ewz1 * ewz4/((sigma_sq1)^(3/2))) *
      wHvar, FUN = "*"), Zvar)
  hessll[(nXvar + 1):(nXvar + nuZUvar), (nXvar + 1):(nXvar + nuZUvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = 2 * (((ewu1 * (S * (0.5 * sigx15_1 - (0.5 * (S^2 * sqewu1 *
      depsisq1 * (epsilon1)^2/(sigma_sq1)^2) - (((0.5 * (ewu1/(sigma_sq1)) +
      1 - 0.5 * (0.5 * (wusq1) + ewu1/(sigma_sq1))) * (wusq1) * ewv1/sigmastar1 +
      (2 - 2 * (sigx2_1^2 * ewu1 * (sigma_sq1)/sqsq1^2)) * sigmastar1)/sqsq1^2 +
      S^2 * sqewu1^2 * ewu1 * (epsilon1)^2/sqsq1) * depsisq1) * dmusig1) *
      (epsilon1) - 0.5 * sigx12_1) + S * sigx11_1 * (epsilon1) - sigx5_1)/(sigwz1) -
      sigx17_1 * ewu1 * sigx6_1/(sigwz1)^2) * ewu1 * ewz1) * wHvar, FUN = "*"),
    uHvar)
  hessll[(nXvar + 1):(nXvar + nuZUvar), (nXvar + nuZUvar + 1):(nXvar + nuZUvar +
    nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = 2 * (((S * (((((0.5 *
    ((wusq1) * ewv1) - S^2 * sigx3_1 * sqewu1 * ewu1 * (epsilon1)^2)/(sigma_sq1) +
    0.5 * ((ewu1/(sigma_sq1) - 1) * ewv1/(sigma_sq1) + 1 - 0.5 * ((wusq1) * (wvsq1)))) *
    depsisq1/sigmastar1 + 0.5 * (S^2 * sigx3_1 * depsisq1 * (epsilon1)^2/(sigma_sq1)^2)) *
    ewu1 + sigx3_1 * (1 - 2 * (sigx2_1 * ewu1 * s3xq1)) * depsisq1) * dmusig1/sqsq1^2 +
    0.5 * sigx15_1) * (epsilon1) - 0.5 * sigx12_1)/(sigwz1) - sigx17_1 * sigx7_1/(sigwz1)^2) *
  ...
  hessll[(nXvar + 1):(nXvar + nuZUvar), (nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar +
    ...
    sigx1_2 * ewu1 * (sigma_sq2) * ewz1 * ewz2 * sigx6_1 * sqrt(sigma_sq2)/(sigsq_2^2 *
  ...
  hessll[(nXvar + 1):(nXvar + nuZUvar), (2 * nXvar + nuZUvar + nvZVvar + 1):(2 *
    ...
    (ewu1 * ewu2 * ewz1 * ewz2 * sigx6_1 * sigx6_2 * sqrt(sigma_sq2)/((sigwz2)^2 *
  ...
  hessll[(nXvar + 1):(nXvar + nuZUvar), (2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 *
    ...
    STATS = -(4 * (ewu1 * ewv2 * ewz1 * ewz2 * sigx7_2 * sigx6_1 * sqrt(sigma_sq2)/((sigwz2)^2 *
  ...
  hessll[(nXvar + 1):(nXvar + nuZUvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar +
    ...
    MARGIN = 1, STATS = sigx4w5z * ewu1 * ewz1 * sigx6_1/sqrt(sigma_sq1) * wHvar,
    FUN = "*"), Zvar)
  hessll[(nXvar + 1):(nXvar + nuZUvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar +
    nZHvar + 1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = -(sigx4w2z * ewu1 * ewz1 * ewz2 * sigx6_1/sqrt(sigma_sq1)) *
      wHvar, FUN = "*"), Zvar)
  hessll[(nXvar + 1):(nXvar + nuZUvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar +
    2 * nZHvar + 1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = -(sigx4w3z * ewu1 * ewz1 * ewz3 * sigx6_1/sqrt(sigma_sq1)) *
      wHvar, FUN = "*"), Zvar)
  hessll[(nXvar + 1):(nXvar + nuZUvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar +
    3 * nZHvar + 1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = -(sigx4w4z * ewu1 * ewz1 * ewz4 * sigx6_1/sqrt(sigma_sq1)) *
      wHvar, FUN = "*"), Zvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (nXvar + nuZUvar +
    1):(nXvar + nuZUvar + nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = 2 *
    (((S * ((((0.5 * (ewv1/(sigma_sq1)) - 0.5 * (0.5 * (wvsq1) + ewv1/(sigma_sq1))) *
      (wvsq1) + S^2 * sigx3_1^2 * ewu1 * ewv1 * (epsilon1)^2/(sqsq1^2 * (sigma_sq1))) *
      depsisq1 * ewu1/sigmastar1 + ((0.5 * (S^2 * depsisq1 * (epsilon1)^2/(sigma_sq1)^2) -
      2 * (sigx3_1 * depsisq1 * s3xq1)) * ewv1 + depsisq1) * sigx3_1) * dmusig1 *
      ewu1/sqsq1^2 + S * (0.5 * (ewv1 * sigx19_1) + 0.5 * pmusig1) * depsisq1 *
      (epsilon1)/(sigma_sq1)^2) * (epsilon1) - (0.5 * (depsisq1 * pmusig1) +
      0.5 * (ewv1 * sigx13_1))/(sigma_sq1))/(sigwz1) - sigx18_1 * ewv1 * sigx7_1/(sigwz1)^2) *
      ewv1 * ewz1) * wHvar, FUN = "*"), vHvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (nXvar + nuZUvar +
    nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1,
    STATS = -(4 * (S * sigx1_2 * (sigma_sq2) * ewv1 * ewz1 * ewz2 * sigx7_1 *
      sqrt(sigma_sq2)/(sigsq_2^2 * sqrt(sigma_sq1)))) * wHvar, FUN = "*"),
    Xvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (2 * nXvar + nuZUvar +
    nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = -(4 * (ewu2 * ewv1 * ewz1 * ewz2 * sigx7_1 * sigx6_2 *
      sqrt(sigma_sq2)/((sigwz2)^2 * sqrt(sigma_sq1)))) * wHvar, FUN = "*"),
    uHvar)
  ...
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (3 * nXvar + 2 * nuZUvar +
    ...
    MARGIN = 1, STATS = -(4 * (ewu3 * ewv1 * ewz1 * ewz3 * sigx7_1 * sigx6_3 *
      sqrt(sigma_sq3)/((sigwz3)^2 * sqrt(sigma_sq1)))) * wHvar, FUN = "*"),
    uHvar)
  ...
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (4 * nXvar + 3 * nuZUvar +
    ...
    MARGIN = 1, STATS = -(4 * (ewu4 * ewv1 * ewz1 * ewz4 * sigx7_1 * sigx6_4 *
      sqrt(sigma_sq4)/((sigwz4)^2 * sqrt(sigma_sq1)))) * wHvar, FUN = "*"),
    uHvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (4 * nXvar + 4 * nuZUvar +
    ...
    MARGIN = 1, STATS = -(4 * (ewv1 * ewv4 * ewz1 * ewz4 * sigx7_1 * sigx7_4 *
      sqrt(sigma_sq4)/((sigwz4)^2 * sqrt(sigma_sq1)))) * wHvar, FUN = "*"),
    vHvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (4 * nXvar + 4 * nuZUvar +
    4 * nvZVvar + 1):(5 * nXvar + 4 * nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = -(4 * (S * prC * sigx1_5 * (sigma_sq5) * ewv1 * ewz1 *
      sigx7_1 * sqrt(sigma_sq5)/(sigsq_5^2 * wzdsq1))) * wHvar, FUN = "*"),
    Xvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (5 * nXvar + 4 * nuZUvar +
    ...
    MARGIN = 1, STATS = -(4 * (prC * ewu5 * ewv1 * ewz1 * sigx7_1 * sigx6_5 *
      sqrt(sigma_sq5)/((sigwz5)^2 * wzdsq1))) * wHvar, FUN = "*"), uHvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (5 * nXvar + 5 * nuZUvar +
    ...
    MARGIN = 1, STATS = -(4 * (prC * ewv1 * ewv5 * ewz1 * sigx7_1 * sigx7_5 *
      sqrt(sigma_sq5)/((sigwz5)^2 * wzdsq1))) * wHvar, FUN = "*"), vHvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = sigx4w5z * ewv1 * ewz1 * sigx7_1/sqrt(sigma_sq1) * wHvar,
    FUN = "*"), Zvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar + nZHvar + 1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = -(sigx4w2z * ewv1 * ewz1 * ewz2 * sigx7_1/sqrt(sigma_sq1)) *
      wHvar, FUN = "*"), Zvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar + 2 * nZHvar + 1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 *
    nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(sigx4w3z * ewv1 *
    ewz1 * ewz3 * sigx7_1/sqrt(sigma_sq1)) * wHvar, FUN = "*"), Zvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar + 3 * nZHvar + 1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 *
    nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(sigx4w4z * ewv1 *
    ewz1 * ewz4 * sigx7_1/sqrt(sigma_sq1)) * wHvar, FUN = "*"), Zvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (nXvar +
    ...
    MARGIN = 1, STATS = 2 * (S^2 * ((depsisq2 * (S * (dmusig2 * ewu2/sigmastar2 +
      S * pmusig2 * (epsilon2)) * (epsilon2)/(sigma_sq2) - pmusig2) + S * dmusig2 *
      (duv2) * ewu2 * (epsilon2)/sqsq2)/sigsq_2 - 2 * (sigx1_2^2 * ewz2/sigsq_2^2)) *
      ewz2) * wHvar, FUN = "*"), Xvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (2 *
    ...
    MARGIN = 1, STATS = 2 * (S * ((sqewu2 * dmusig2 * depsisq2 + (S * (sigx10_2 -
      S * sqewu2 * dmusig2 * (duv2) * (epsilon2)) * (epsilon2) - 0.5 * (sigx1_2/(sigma_sq2)))/(sigma_sq2))/(sigwz2) -
      2 * (sigx1_2 * ewz2 * sigx6_2/((sigwz2)^2 * (sigma_sq2)))) * ewu2 * ewz2) *
      wHvar, FUN = "*"), uHvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (2 *
    nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = 2 * (S * (((S * (sigx10_2 + S * sigx3_2 * dmusig2 * (duv2) *
      ewu2 * (epsilon2)/sqsq2^2) * (epsilon2) - 0.5 * (sigx1_2/(sigma_sq2)))/(sigma_sq2) -
      sigx3_2 * dmusig2 * depsisq2 * ewu2/sqsq2^2)/(sigwz2) - 2 * (sigx1_2 *
      ewz2 * sigx7_2/((sigwz2)^2 * (sigma_sq2)))) * ewv2 * ewz2) * wHvar, FUN = "*"),
    vHvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (2 *
    ...
    MARGIN = 1, STATS = -(4 * (S^2 * sigx1_2 * sigx1_3 * (sigma_sq3) * ewz2 *
      ewz3 * sqrt(sigma_sq3)/(sigsq_3^2 * (sigma_sq2)^(3/2)))) * wHvar, FUN = "*"),
    Xvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (3 *
    ...
    MARGIN = 1, STATS = -(4 * (S * sigx1_2 * ewu3 * ewz2 * ewz3 * sigx6_3 * sqrt(sigma_sq3)/((sigwz3)^2 *
      (sigma_sq2)^(3/2)))) * wHvar, FUN = "*"), uHvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (3 *
    nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = -(4 * (S * sigx1_2 * ewv3 * ewz2 * ewz3 * sigx7_3 * sqrt(sigma_sq3)/((sigwz3)^2 *
  ...
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (3 *
    ...
    MARGIN = 1, STATS = -(4 * (S^2 * sigx1_2 * sigx1_4 * (sigma_sq4) * ewz2 *
      ewz4 * sqrt(sigma_sq4)/(sigsq_4^2 * (sigma_sq2)^(3/2)))) * wHvar, FUN = "*"),
    Xvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (4 *
    ...
    MARGIN = 1, STATS = -(4 * (S * sigx1_2 * ewu4 * ewz2 * ewz4 * sigx6_4 * sqrt(sigma_sq4)/((sigwz4)^2 *
      (sigma_sq2)^(3/2)))) * wHvar, FUN = "*"), uHvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (4 *
    nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = -(4 * (S * sigx1_2 * ewv4 * ewz2 * ewz4 * sigx7_4 * sqrt(sigma_sq4)/((sigwz4)^2 *
      (sigma_sq2)^(3/2)))) * wHvar, FUN = "*"), vHvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (4 *
    nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 * nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = -(4 * (S^2 * prC * sigx1_2 * sigx1_5 * (sigma_sq5) *
      ewz2 * sqrt(sigma_sq5)/(wzc1 * (sigma_sq2)^(3/2)))) * wHvar, FUN = "*"),
    Xvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (5 *
    nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = -(4 * (S * prC * sigx1_2 * ewu5 * ewz2 * sigx6_5 * sqrt(sigma_sq5)/wzsigx4_2)) *
      wHvar, FUN = "*"), uHvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (5 *
    nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = -(4 * (S * prC * sigx1_2 * ewv5 * ewz2 * sigx7_5 * sqrt(sigma_sq5)/wzsigx4_2)) *
      wHvar, FUN = "*"), vHvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar +
    nZHvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(S * sigx4w1z * sigx1_2 *
    ewz1 * ewz2/((sigma_sq2)^(3/2))) * wHvar, FUN = "*"), Zvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = S *
    sigx4w6z * sigx1_2 * ewz2/((sigma_sq2)^(3/2)) * wHvar, FUN = "*"), Zvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar + 1):(5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(S *
    sigx4w3z * sigx1_2 * ewz2 * ewz3/((sigma_sq2)^(3/2))) * wHvar, FUN = "*"),
    Zvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar + nvZVvar), (5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar + 1):(5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(S *
    sigx4w4z * sigx1_2 * ewz2 * ewz4/((sigma_sq2)^(3/2))) * wHvar, FUN = "*"),
    Zvar)
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar),
    ...
    MARGIN = 1, STATS = 2 * (((ewu2 * (S * (0.5 * sigx15_2 - (0.5 * (S^2 * sqewu2 *
      depsisq2 * (epsilon2)^2/(sigma_sq2)^2) - (((0.5 * (ewu2/(sigma_sq2)) +
      1 - 0.5 * (0.5 * (wusq2) + ewu2/(sigma_sq2))) * (wusq2) * ewv2/sigmastar2 +
      (2 - 2 * (sigx2_2^2 * ewu2 * (sigma_sq2)/sqsq2^2)) * sigmastar2)/sqsq2^2 +
      S^2 * sqewu2^2 * ewu2 * (epsilon2)^2/sqsq2) * depsisq2) * dmusig2) *
      (epsilon2) - 0.5 * sigx12_2) + S * sigx11_2 * (epsilon2) - sigx5_2)/(sigwz2) -
      sigx17_2 * ewu2 * sigx6_2/(sigwz2)^2) * ewu2 * ewz2) * wHvar, FUN = "*"),
    uHvar)
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar),
    (2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = 2 * (((S * (((((0.5 * ((wusq2) * ewv2) - S^2 * sigx3_2 *
      sqewu2 * ewu2 * (epsilon2)^2)/(sigma_sq2) + 0.5 * ((ewu2/(sigma_sq2) -
      1) * ewv2/(sigma_sq2) + 1 - 0.5 * ((wusq2) * (wvsq2)))) * depsisq2/sigmastar2 +
      0.5 * (S^2 * sigx3_2 * depsisq2 * (epsilon2)^2/(sigma_sq2)^2)) * ewu2 +
      sigx3_2 * (1 - 2 * (sigx2_2 * ewu2 * s3xq2)) * depsisq2) * dmusig2/sqsq2^2 +
      0.5 * sigx15_2) * (epsilon2) - 0.5 * sigx12_2)/(sigwz2) - sigx17_2 *
      sigx7_2/(sigwz2)^2) * ewu2 * ewv2 * ewz2) * wHvar, FUN = "*"), vHvar)
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar),
    (2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 2 * nuZUvar + 2 *
      nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 * (S * sigx1_3 *
    ewu2 * (sigma_sq3) * ewz2 * ewz3 * sigx6_2 * sqrt(sigma_sq3)/(sigsq_3^2 *
  ...
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar),
    ...
    ewu3 * ewz2 * ewz3 * sigx6_2 * sigx6_3 * sqrt(sigma_sq3)/((sigwz3)^2 * sqrt(sigma_sq2)))) *
    wHvar, FUN = "*"), uHvar)
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar),
    (3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar + 3 *
      nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 * (ewu2 *
    ewv3 * ewz2 * ewz3 * sigx7_3 * sigx6_2 * sqrt(sigma_sq3)/((sigwz3)^2 * sqrt(sigma_sq2)))) *
    wHvar, FUN = "*"), vHvar)
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar),
    (3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 * nuZUvar + 3 *
      nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 * (S * sigx1_4 *
    ewu2 * (sigma_sq4) * ewz2 * ewz4 * sigx6_2 * sqrt(sigma_sq4)/(sigsq_4^2 *
    sqrt(sigma_sq2)))) * wHvar, FUN = "*"), Xvar)
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar),
    (4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar + 3 *
      nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 * (ewu2 *
    ewu4 * ewz2 * ewz4 * sigx6_2 * sigx6_4 * sqrt(sigma_sq4)/((sigwz4)^2 * sqrt(sigma_sq2)))) *
    wHvar, FUN = "*"), uHvar)
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar),
    (4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar + 4 *
      nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 * (ewu2 *
    ewv4 * ewz2 * ewz4 * sigx7_4 * sigx6_2 * sqrt(sigma_sq4)/((sigwz4)^2 * sqrt(sigma_sq2)))) *
    wHvar, FUN = "*"), vHvar)
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar),
    (4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 * nuZUvar + 4 *
      nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 * (S * prC *
    sigx1_5 * ewu2 * (sigma_sq5) * ewz2 * sigx6_2 * sqrt(sigma_sq5)/(sigsq_5^2 *
    wzdsq2))) * wHvar, FUN = "*"), Xvar)
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar),
    (5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar + 4 *
      nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 * (prC *
    ewu2 * ewu5 * ewz2 * sigx6_2 * sigx6_5 * sqrt(sigma_sq5)/((sigwz5)^2 * wzdsq2))) *
    wHvar, FUN = "*"), uHvar)
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar),
    (5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar + 5 *
      nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 * (prC *
    ewu2 * ewv5 * ewz2 * sigx7_5 * sigx6_2 * sqrt(sigma_sq5)/((sigwz5)^2 * wzdsq2))) *
    wHvar, FUN = "*"), vHvar)
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar),
    (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar + 5 *
      nvZVvar + nZHvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(sigx4w1z *
    ewu2 * ewz1 * ewz2 * sigx6_2/sqrt(sigma_sq2)) * wHvar, FUN = "*"), Zvar)
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar),
    (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar + 5 * nuZUvar +
      5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = sigx4w6z *
    ewu2 * ewz2 * sigx6_2/sqrt(sigma_sq2) * wHvar, FUN = "*"), Zvar)
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar),
    (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar + 1):(5 * nXvar + 5 *
      nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(uHvar, MARGIN = 1,
    STATS = -(sigx4w3z * ewu2 * ewz2 * ewz3 * sigx6_2/sqrt(sigma_sq2)) * wHvar,
    FUN = "*"), Zvar)
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + nvZVvar),
    (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar + 1):(5 * nXvar + 5 *
      nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(uHvar, MARGIN = 1,
    STATS = -(sigx4w4z * ewu2 * ewz2 * ewz4 * sigx6_2/sqrt(sigma_sq2)) * wHvar,
    FUN = "*"), Zvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 *
    ...
    (ewv2/(sigma_sq2)) - 0.5 * (0.5 * (wvsq2) + ewv2/(sigma_sq2))) * (wvsq2) +
    S^2 * sigx3_2^2 * ewu2 * ewv2 * (epsilon2)^2/(sqsq2^2 * (sigma_sq2))) * depsisq2 *
    ewu2/sigmastar2 + ((0.5 * (S^2 * depsisq2 * (epsilon2)^2/(sigma_sq2)^2) -
    2 * (sigx3_2 * depsisq2 * s3xq2)) * ewv2 + depsisq2) * sigx3_2) * dmusig2 *
    ewu2/sqsq2^2 + S * (0.5 * (ewv2 * sigx19_2) + 0.5 * pmusig2) * depsisq2 *
    (epsilon2)/(sigma_sq2)^2) * (epsilon2) - (0.5 * (depsisq2 * pmusig2) + 0.5 *
    (ewv2 * sigx13_2))/(sigma_sq2))/(sigwz2) - sigx18_2 * ewv2 * sigx7_2/(sigwz2)^2) *
  ...
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 *
    ...
    (sigma_sq3) * ewv2 * ewz2 * ewz3 * sigx7_2 * sqrt(sigma_sq3)/(sigsq_3^2 *
    sqrt(sigma_sq2)))) * wHvar, FUN = "*"), Xvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 *
    nvZVvar), (3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    2 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 * (ewu3 *
    ewv2 * ewz2 * ewz3 * sigx7_2 * sigx6_3 * sqrt(sigma_sq3)/((sigwz3)^2 * sqrt(sigma_sq2)))) *
    wHvar, FUN = "*"), uHvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 *
    nvZVvar), (3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    3 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 * (ewv2 *
    ewv3 * ewz2 * ewz3 * sigx7_2 * sigx7_3 * sqrt(sigma_sq3)/((sigwz3)^2 * sqrt(sigma_sq2)))) *
    wHvar, FUN = "*"), vHvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 *
    nvZVvar), (3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 * nuZUvar +
    3 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 * (S * sigx1_4 *
    (sigma_sq4) * ewv2 * ewz2 * ewz4 * sigx7_2 * sqrt(sigma_sq4)/(sigsq_4^2 *
    sqrt(sigma_sq2)))) * wHvar, FUN = "*"), Xvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 *
    nvZVvar), (4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    3 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 * (ewu4 *
    ewv2 * ewz2 * ewz4 * sigx7_2 * sigx6_4 * sqrt(sigma_sq4)/((sigwz4)^2 * sqrt(sigma_sq2)))) *
    wHvar, FUN = "*"), uHvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 *
    nvZVvar), (4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    4 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 * (ewv2 *
    ewv4 * ewz2 * ewz4 * sigx7_2 * sigx7_4 * sqrt(sigma_sq4)/((sigwz4)^2 * sqrt(sigma_sq2)))) *
    wHvar, FUN = "*"), vHvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 *
    nvZVvar), (4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 * nuZUvar +
    4 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 * (S * prC *
    sigx1_5 * (sigma_sq5) * ewv2 * ewz2 * sigx7_2 * sqrt(sigma_sq5)/(sigsq_5^2 *
    wzdsq2))) * wHvar, FUN = "*"), Xvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 *
    nvZVvar), (5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    4 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 * (prC *
    ewu5 * ewv2 * ewz2 * sigx7_2 * sigx6_5 * sqrt(sigma_sq5)/((sigwz5)^2 * wzdsq2))) *
    wHvar, FUN = "*"), uHvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 *
    nvZVvar), (5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 * (prC *
    ewv2 * ewv5 * ewz2 * sigx7_2 * sigx7_5 * sqrt(sigma_sq5)/((sigwz5)^2 * wzdsq2))) *
    wHvar, FUN = "*"), vHvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 *
    nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar + nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(sigx4w1z *
    ewv2 * ewz1 * ewz2 * sigx7_2/sqrt(sigma_sq2)) * wHvar, FUN = "*"), Zvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 *
    nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1,
    STATS = sigx4w6z * ewv2 * ewz2 * sigx7_2/sqrt(sigma_sq2) * wHvar, FUN = "*"),
    Zvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 *
    nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1,
    STATS = -(sigx4w3z * ewv2 * ewz2 * ewz3 * sigx7_2/sqrt(sigma_sq2)) * wHvar,
    FUN = "*"), Zvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar + 2 * nuZUvar + 2 *
    nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1,
    STATS = -(sigx4w4z * ewv2 * ewz2 * ewz4 * sigx7_2/sqrt(sigma_sq2)) * wHvar,
    FUN = "*"), Zvar)
  hessll[(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 2 * nuZUvar +
    ...
    (S^2 * ((depsisq3 * (S * (dmusig3 * ewu3/sigmastar3 + S * pmusig3 * (epsilon3)) *
      (epsilon3)/(sigma_sq3) - pmusig3) + S * dmusig3 * (duv3) * ewu3 * (epsilon3)/sqsq3)/sigsq_3 -
      2 * (sigx1_3^2 * ewz3/sigsq_3^2)) * ewz3) * wHvar, FUN = "*"), Xvar)
  hessll[(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 2 * nuZUvar +
    2 * nvZVvar), (3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 *
    nuZUvar + 2 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = 2 *
    (S * ((sqewu3 * dmusig3 * depsisq3 + (S * (sigx10_3 - S * sqewu3 * dmusig3 *
      (duv3) * (epsilon3)) * (epsilon3) - 0.5 * (sigx1_3/(sigma_sq3)))/(sigma_sq3))/(sigwz3) -
      2 * (sigx1_3 * ewz3 * sigx6_3/((sigwz3)^2 * (sigma_sq3)))) * ewu3 * ewz3) *
    wHvar, FUN = "*"), uHvar)
  hessll[(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 2 * nuZUvar +
    2 * nvZVvar), (3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 *
    nuZUvar + 3 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = 2 *
    (S * (((S * (sigx10_3 + S * sigx3_3 * dmusig3 * (duv3) * ewu3 * (epsilon3)/sqsq3^2) *
      (epsilon3) - 0.5 * (sigx1_3/(sigma_sq3)))/(sigma_sq3) - sigx3_3 * dmusig3 *
      depsisq3 * ewu3/sqsq3^2)/(sigwz3) - 2 * (sigx1_3 * ewz3 * sigx7_3/((sigwz3)^2 *
      (sigma_sq3)))) * ewv3 * ewz3) * wHvar, FUN = "*"), vHvar)
  hessll[(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 2 * nuZUvar +
    2 * nvZVvar), (3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 *
    nuZUvar + 3 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S^2 * sigx1_3 * sigx1_4 * (sigma_sq4) * ewz3 * ewz4 * sqrt(sigma_sq4)/(sigsq_4^2 *
      (sigma_sq3)^(3/2)))) * wHvar, FUN = "*"), Xvar)
  hessll[(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 2 * nuZUvar +
    2 * nvZVvar), (4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 *
    nuZUvar + 3 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S * sigx1_3 * ewu4 * ewz3 * ewz4 * sigx6_4 * sqrt(sigma_sq4)/((sigwz4)^2 *
      (sigma_sq3)^(3/2)))) * wHvar, FUN = "*"), uHvar)
  hessll[(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 2 * nuZUvar +
    2 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S * sigx1_3 * ewv4 * ewz3 * ewz4 * sigx7_4 * sqrt(sigma_sq4)/((sigwz4)^2 *
      (sigma_sq3)^(3/2)))) * wHvar, FUN = "*"), vHvar)
  hessll[(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 2 * nuZUvar +
    2 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S^2 * prC * sigx1_3 * sigx1_5 * (sigma_sq5) * ewz3 * sqrt(sigma_sq5)/(wzc1 *
      (sigma_sq3)^(3/2)))) * wHvar, FUN = "*"), Xvar)
  hessll[(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 2 * nuZUvar +
    2 * nvZVvar), (5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S * prC * sigx1_3 * ewu5 * ewz3 * sigx6_5 * sqrt(sigma_sq5)/wzsigx4_3)) *
    wHvar, FUN = "*"), uHvar)
  hessll[(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 2 * nuZUvar +
    2 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S * prC * sigx1_3 * ewv5 * ewz3 * sigx7_5 * sqrt(sigma_sq5)/wzsigx4_3)) *
    wHvar, FUN = "*"), vHvar)
  hessll[(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 2 * nuZUvar +
    2 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar + nZHvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(S *
    sigx4w1z * sigx1_3 * ewz1 * ewz3/((sigma_sq3)^(3/2))) * wHvar, FUN = "*"),
    Zvar)
  hessll[(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 2 * nuZUvar +
    2 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(Xvar, MARGIN = 1,
    STATS = -(S * sigx4w2z * sigx1_3 * ewz2 * ewz3/((sigma_sq3)^(3/2))) * wHvar,
    FUN = "*"), Zvar)
  hessll[(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 2 * nuZUvar +
    2 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = S * sigx4w7z * sigx1_3 * ewz3/((sigma_sq3)^(3/2)) * wHvar,
    FUN = "*"), Zvar)
  hessll[(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 2 * nuZUvar +
    2 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = -(S * sigx4w4z * sigx1_3 * ewz3 * ewz4/((sigma_sq3)^(3/2))) *
      wHvar, FUN = "*"), Zvar)
  hessll[(3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    2 * nvZVvar), (3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 *
    nuZUvar + 2 * nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = 2 *
    (((ewu3 * (S * (0.5 * sigx15_3 - (0.5 * (S^2 * sqewu3 * depsisq3 * (epsilon3)^2/(sigma_sq3)^2) -
      (((0.5 * (ewu3/(sigma_sq3)) + 1 - 0.5 * (0.5 * (wusq3) + ewu3/(sigma_sq3))) *
        (wusq3) * ewv3/sigmastar3 + (2 - 2 * (sigx2_3^2 * ewu3 * (sigma_sq3)/sqsq3^2)) *
        sigmastar3)/sqsq3^2 + S^2 * sqewu3^2 * ewu3 * (epsilon3)^2/sqsq3) *
        depsisq3) * dmusig3) * (epsilon3) - 0.5 * sigx12_3) + S * sigx11_3 *
      (epsilon3) - sigx5_3)/(sigwz3) - sigx17_3 * ewu3 * sigx6_3/(sigwz3)^2) *
      ewu3 * ewz3) * wHvar, FUN = "*"), uHvar)
  hessll[(3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    2 * nvZVvar), (3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 *
    nuZUvar + 3 * nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = 2 *
    (((S * (((((0.5 * ((wusq3) * ewv3) - S^2 * sigx3_3 * sqewu3 * ewu3 * (epsilon3)^2)/(sigma_sq3) +
      0.5 * ((ewu3/(sigma_sq3) - 1) * ewv3/(sigma_sq3) + 1 - 0.5 * ((wusq3) *
        (wvsq3)))) * depsisq3/sigmastar3 + 0.5 * (S^2 * sigx3_3 * depsisq3 *
      (epsilon3)^2/(sigma_sq3)^2)) * ewu3 + sigx3_3 * (1 - 2 * (sigx2_3 * ewu3 *
      s3xq3)) * depsisq3) * dmusig3/sqsq3^2 + 0.5 * sigx15_3) * (epsilon3) -
      0.5 * sigx12_3)/(sigwz3) - sigx17_3 * sigx7_3/(sigwz3)^2) * ewu3 * ewv3 *
      ewz3) * wHvar, FUN = "*"), vHvar)
  hessll[(3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    2 * nvZVvar), (3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 *
    nuZUvar + 3 * nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 *
    (S * sigx1_4 * ewu3 * (sigma_sq4) * ewz3 * ewz4 * sigx6_3 * sqrt(sigma_sq4)/(sigsq_4^2 *
      sqrt(sigma_sq3)))) * wHvar, FUN = "*"), Xvar)
  hessll[(3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    2 * nvZVvar), (4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 *
    nuZUvar + 3 * nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 *
    (ewu3 * ewu4 * ewz3 * ewz4 * sigx6_3 * sigx6_4 * sqrt(sigma_sq4)/((sigwz4)^2 *
      sqrt(sigma_sq3)))) * wHvar, FUN = "*"), uHvar)
  hessll[(3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    2 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 *
    (ewu3 * ewv4 * ewz3 * ewz4 * sigx7_4 * sigx6_3 * sqrt(sigma_sq4)/((sigwz4)^2 *
      sqrt(sigma_sq3)))) * wHvar, FUN = "*"), vHvar)
  hessll[(3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    2 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 *
    (S * prC * sigx1_5 * ewu3 * (sigma_sq5) * ewz3 * sigx6_3 * sqrt(sigma_sq5)/(sigsq_5^2 *
      wzdsq3))) * wHvar, FUN = "*"), Xvar)
  hessll[(3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    2 * nvZVvar), (5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 *
    (prC * ewu3 * ewu5 * ewz3 * sigx6_3 * sigx6_5 * sqrt(sigma_sq5)/((sigwz5)^2 *
      wzdsq3))) * wHvar, FUN = "*"), uHvar)
  hessll[(3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    2 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 *
    (prC * ewu3 * ewv5 * ewz3 * sigx7_5 * sigx6_3 * sqrt(sigma_sq5)/((sigwz5)^2 *
      wzdsq3))) * wHvar, FUN = "*"), vHvar)
  hessll[(3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    2 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar + nZHvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(sigx4w1z *
    ewu3 * ewz1 * ewz3 * sigx6_3/sqrt(sigma_sq3)) * wHvar, FUN = "*"), Zvar)
  hessll[(3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    2 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(uHvar, MARGIN = 1,
    STATS = -(sigx4w2z * ewu3 * ewz2 * ewz3 * sigx6_3/sqrt(sigma_sq3)) * wHvar,
    FUN = "*"), Zvar)
  hessll[(3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    2 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = sigx4w7z * ewu3 * ewz3 * sigx6_3/sqrt(sigma_sq3) * wHvar,
    FUN = "*"), Zvar)
  hessll[(3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    2 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = -(sigx4w4z * ewu3 * ewz3 * ewz4 * sigx6_3/sqrt(sigma_sq3)) *
      wHvar, FUN = "*"), Zvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    ...
    (((S * ((((0.5 * (ewv3/(sigma_sq3)) - 0.5 * (0.5 * (wvsq3) + ewv3/(sigma_sq3))) *
      (wvsq3) + S^2 * sigx3_3^2 * ewu3 * ewv3 * (epsilon3)^2/(sqsq3^2 * (sigma_sq3))) *
      depsisq3 * ewu3/sigmastar3 + ((0.5 * (S^2 * depsisq3 * (epsilon3)^2/(sigma_sq3)^2) -
      2 * (sigx3_3 * depsisq3 * s3xq3)) * ewv3 + depsisq3) * sigx3_3) * dmusig3 *
      ewu3/sqsq3^2 + S * (0.5 * (ewv3 * sigx19_3) + 0.5 * pmusig3) * depsisq3 *
      (epsilon3)/(sigma_sq3)^2) * (epsilon3) - (0.5 * (depsisq3 * pmusig3) +
      0.5 * (ewv3 * sigx13_3))/(sigma_sq3))/(sigwz3) - sigx18_3 * ewv3 * sigx7_3/(sigwz3)^2) *
  ...
  hessll[(3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    ...
    (S * sigx1_4 * (sigma_sq4) * ewv3 * ewz3 * ewz4 * sigx7_3 * sqrt(sigma_sq4)/(sigsq_4^2 *
      sqrt(sigma_sq3)))) * wHvar, FUN = "*"), Xvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 *
    nuZUvar + 3 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 *
    (ewu4 * ewv3 * ewz3 * ewz4 * sigx7_3 * sigx6_4 * sqrt(sigma_sq4)/((sigwz4)^2 *
      sqrt(sigma_sq3)))) * wHvar, FUN = "*"), uHvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 *
    (ewv3 * ewv4 * ewz3 * ewz4 * sigx7_3 * sigx7_4 * sqrt(sigma_sq4)/((sigwz4)^2 *
      sqrt(sigma_sq3)))) * wHvar, FUN = "*"), vHvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 *
    (S * prC * sigx1_5 * (sigma_sq5) * ewv3 * ewz3 * sigx7_3 * sqrt(sigma_sq5)/(sigsq_5^2 *
      wzdsq3))) * wHvar, FUN = "*"), Xvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 *
    (prC * ewu5 * ewv3 * ewz3 * sigx7_3 * sigx6_5 * sqrt(sigma_sq5)/((sigwz5)^2 *
      wzdsq3))) * wHvar, FUN = "*"), uHvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 *
    (prC * ewv3 * ewv5 * ewz3 * sigx7_3 * sigx7_5 * sqrt(sigma_sq5)/((sigwz5)^2 *
      wzdsq3))) * wHvar, FUN = "*"), vHvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar + nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(sigx4w1z *
    ewv3 * ewz1 * ewz3 * sigx7_3/sqrt(sigma_sq3)) * wHvar, FUN = "*"), Zvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1,
    STATS = -(sigx4w2z * ewv3 * ewz2 * ewz3 * sigx7_3/sqrt(sigma_sq3)) * wHvar,
    FUN = "*"), Zvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = sigx4w7z * ewv3 * ewz3 * sigx7_3/sqrt(sigma_sq3) * wHvar,
    FUN = "*"), Zvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = -(sigx4w4z * ewv3 * ewz3 * ewz4 * sigx7_3/sqrt(sigma_sq3)) *
      wHvar, FUN = "*"), Zvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 *
    nuZUvar + 3 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = 2 *
    (S^2 * ((depsisq4 * (S * (dmusig4 * ewu4/sigmastar4 + S * pmusig4 * (epsilon4)) *
      (epsilon4)/(sigma_sq4) - pmusig4) + S * dmusig4 * (duv4) * ewu4 * (epsilon4)/sqsq4)/sigsq_4 -
      2 * (sigx1_4^2 * ewz4/sigsq_4^2)) * ewz4) * wHvar, FUN = "*"), Xvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 *
    nuZUvar + 3 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = 2 *
    (S * ((sqewu4 * dmusig4 * depsisq4 + (S * (sigx10_4 - S * sqewu4 * dmusig4 *
      (duv4) * (epsilon4)) * (epsilon4) - 0.5 * (sigx1_4/(sigma_sq4)))/(sigma_sq4))/(sigwz4) -
      2 * (sigx1_4 * ewz4 * sigx6_4/((sigwz4)^2 * (sigma_sq4)))) * ewu4 * ewz4) *
    wHvar, FUN = "*"), uHvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = 2 *
    (S * (((S * (sigx10_4 + S * sigx3_4 * dmusig4 * (duv4) * ewu4 * (epsilon4)/sqsq4^2) *
      (epsilon4) - 0.5 * (sigx1_4/(sigma_sq4)))/(sigma_sq4) - sigx3_4 * dmusig4 *
      depsisq4 * ewu4/sqsq4^2)/(sigwz4) - 2 * (sigx1_4 * ewz4 * sigx7_4/((sigwz4)^2 *
      (sigma_sq4)))) * ewv4 * ewz4) * wHvar, FUN = "*"), vHvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S^2 * prC * sigx1_4 * sigx1_5 * (sigma_sq5) * ewz4 * sqrt(sigma_sq5)/(wzc1 *
      (sigma_sq4)^(3/2)))) * wHvar, FUN = "*"), Xvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S * prC * sigx1_4 * ewu5 * ewz4 * sigx6_5 * sqrt(sigma_sq5)/wzsigx4_4)) *
    wHvar, FUN = "*"), uHvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(4 *
    (S * prC * sigx1_4 * ewv5 * ewz4 * sigx7_5 * sqrt(sigma_sq5)/wzsigx4_4)) *
    wHvar, FUN = "*"), vHvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar + nZHvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(S *
    sigx4w1z * sigx1_4 * ewz1 * ewz4/((sigma_sq4)^(3/2))) * wHvar, FUN = "*"),
    Zvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(Xvar, MARGIN = 1,
    STATS = -(S * sigx4w2z * sigx1_4 * ewz2 * ewz4/((sigma_sq4)^(3/2))) * wHvar,
    FUN = "*"), Zvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = -(S * sigx4w3z * sigx1_4 * ewz3 * ewz4/((sigma_sq4)^(3/2))) *
      wHvar, FUN = "*"), Zvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 3 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = S * sigx4w8z * sigx1_4 * ewz4/((sigma_sq4)^(3/2)) * wHvar,
    FUN = "*"), Zvar)
  hessll[(4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    3 * nvZVvar), (4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 *
    nuZUvar + 3 * nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = 2 *
    (((ewu4 * (S * (0.5 * sigx15_4 - (0.5 * (S^2 * sqewu4 * depsisq4 * (epsilon4)^2/(sigma_sq4)^2) -
      (((0.5 * (ewu4/(sigma_sq4)) + 1 - 0.5 * (0.5 * (wusq4) + ewu4/(sigma_sq4))) *
        (wusq4) * ewv4/sigmastar4 + (2 - 2 * (sigx2_4^2 * ewu4 * (sigma_sq4)/sqsq4^2)) *
        sigmastar4)/sqsq4^2 + S^2 * sqewu4^2 * ewu4 * (epsilon4)^2/sqsq4) *
        depsisq4) * dmusig4) * (epsilon4) - 0.5 * sigx12_4) + S * sigx11_4 *
      (epsilon4) - sigx5_4)/(sigwz4) - sigx17_4 * ewu4 * sigx6_4/(sigwz4)^2) *
      ewu4 * ewz4) * wHvar, FUN = "*"), uHvar)
  hessll[(4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    3 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = 2 *
    (((S * (((((0.5 * ((wusq4) * ewv4) - S^2 * sigx3_4 * sqewu4 * ewu4 * (epsilon4)^2)/(sigma_sq4) +
      0.5 * ((ewu4/(sigma_sq4) - 1) * ewv4/(sigma_sq4) + 1 - 0.5 * ((wusq4) *
        (wvsq4)))) * depsisq4/sigmastar4 + 0.5 * (S^2 * sigx3_4 * depsisq4 *
      (epsilon4)^2/(sigma_sq4)^2)) * ewu4 + sigx3_4 * (1 - 2 * (sigx2_4 * ewu4 *
      s3xq4)) * depsisq4) * dmusig4/sqsq4^2 + 0.5 * sigx15_4) * (epsilon4) -
      0.5 * sigx12_4)/(sigwz4) - sigx17_4 * sigx7_4/(sigwz4)^2) * ewu4 * ewv4 *
      ewz4) * wHvar, FUN = "*"), vHvar)
  hessll[(4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    3 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 *
    (S * prC * sigx1_5 * ewu4 * (sigma_sq5) * ewz4 * sigx6_4 * sqrt(sigma_sq5)/(sigsq_5^2 *
      wzdsq4))) * wHvar, FUN = "*"), Xvar)
  hessll[(4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 *
    (prC * ewu4 * ewu5 * ewz4 * sigx6_4 * sigx6_5 * sqrt(sigma_sq5)/((sigwz5)^2 *
      wzdsq4))) * wHvar, FUN = "*"), uHvar)
  hessll[(4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(4 *
    (prC * ewu4 * ewv5 * ewz4 * sigx7_5 * sigx6_4 * sqrt(sigma_sq5)/((sigwz5)^2 *
      wzdsq4))) * wHvar, FUN = "*"), vHvar)
  hessll[(4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar + nZHvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(sigx4w1z *
    ewu4 * ewz1 * ewz4 * sigx6_4/sqrt(sigma_sq4)) * wHvar, FUN = "*"), Zvar)
  hessll[(4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(uHvar, MARGIN = 1,
    STATS = -(sigx4w2z * ewu4 * ewz2 * ewz4 * sigx6_4/sqrt(sigma_sq4)) * wHvar,
    FUN = "*"), Zvar)
  hessll[(4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = -(sigx4w3z * ewu4 * ewz3 * ewz4 * sigx6_4/sqrt(sigma_sq4)) *
      wHvar, FUN = "*"), Zvar)
  hessll[(4 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    3 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = sigx4w8z * ewu4 * ewz4 * sigx6_4/sqrt(sigma_sq4) * wHvar,
    FUN = "*"), Zvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    ...
    (((S * ((((0.5 * (ewv4/(sigma_sq4)) - 0.5 * (0.5 * (wvsq4) + ewv4/(sigma_sq4))) *
      (wvsq4) + S^2 * sigx3_4^2 * ewu4 * ewv4 * (epsilon4)^2/(sqsq4^2 * (sigma_sq4))) *
      depsisq4 * ewu4/sigmastar4 + ((0.5 * (S^2 * depsisq4 * (epsilon4)^2/(sigma_sq4)^2) -
      2 * (sigx3_4 * depsisq4 * s3xq4)) * ewv4 + depsisq4) * sigx3_4) * dmusig4 *
      ewu4/sqsq4^2 + S * (0.5 * (ewv4 * sigx19_4) + 0.5 * pmusig4) * depsisq4 *
      (epsilon4)/(sigma_sq4)^2) * (epsilon4) - (0.5 * (depsisq4 * pmusig4) +
      0.5 * (ewv4 * sigx13_4))/(sigma_sq4))/(sigwz4) - sigx18_4 * ewv4 * sigx7_4/(sigwz4)^2) *
      ewv4 * ewz4) * wHvar, FUN = "*"), vHvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    4 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 *
    (S * prC * sigx1_5 * (sigma_sq5) * ewv4 * ewz4 * sigx7_4 * sqrt(sigma_sq5)/(sigsq_5^2 *
      wzdsq4))) * wHvar, FUN = "*"), Xvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 *
    (prC * ewu5 * ewv4 * ewz4 * sigx7_4 * sigx6_5 * sqrt(sigma_sq5)/((sigwz5)^2 *
      wzdsq4))) * wHvar, FUN = "*"), uHvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(4 *
    (prC * ewv4 * ewv5 * ewz4 * sigx7_4 * sigx7_5 * sqrt(sigma_sq5)/((sigwz5)^2 *
      wzdsq4))) * wHvar, FUN = "*"), vHvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar + nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(sigx4w1z *
    ewv4 * ewz1 * ewz4 * sigx7_4/sqrt(sigma_sq4)) * wHvar, FUN = "*"), Zvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1,
    STATS = -(sigx4w2z * ewv4 * ewz2 * ewz4 * sigx7_4/sqrt(sigma_sq4)) * wHvar,
    FUN = "*"), Zvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = -(sigx4w3z * ewv4 * ewz3 * ewz4 * sigx7_4/sqrt(sigma_sq4)) *
      wHvar, FUN = "*"), Zvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 3 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = sigx4w8z * ewv4 * ewz4 * sigx7_4/sqrt(sigma_sq4) * wHvar,
    FUN = "*"), Zvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 * nuZUvar +
    4 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = 2 *
    (S^2 * ((depsisq5 * (S * (dmusig5 * ewu5/sigmastar5 + S * pmusig5 * (epsilon5)) *
      (epsilon5)/(sigma_sq5) - pmusig5) + S * dmusig5 * (duv5) * ewu5 * (epsilon5)/sqsq5)/sigsq_5 -
      2 * (prC * sigx1_5^2/sigsq_5^2)) * prC) * wHvar, FUN = "*"), Xvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = 2 *
    (S * ((sqewu5 * dmusig5 * depsisq5 + (S * (sigx10_5 - S * sqewu5 * dmusig5 *
      (duv5) * (epsilon5)) * (epsilon5) - 0.5 * (sigx1_5/(sigma_sq5)))/(sigma_sq5))/(sigwz5) -
      2 * (prC * sigx1_5 * sigx6_5/((sigwz5)^2 * (sigma_sq5)))) * prC * ewu5) *
    wHvar, FUN = "*"), uHvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = 2 *
    (S * (((S * (sigx10_5 + S * sigx3_5 * dmusig5 * (duv5) * ewu5 * (epsilon5)/sqsq5^2) *
      (epsilon5) - 0.5 * (sigx1_5/(sigma_sq5)))/(sigma_sq5) - sigx3_5 * dmusig5 *
      depsisq5 * ewu5/sqsq5^2)/(sigwz5) - 2 * (prC * sigx1_5 * sigx7_5/((sigwz5)^2 *
      (sigma_sq5)))) * prC * ewv5) * wHvar, FUN = "*"), vHvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar + nZHvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = -(S *
    prC * sigx4w9z * sigx1_5 * ewz1/((sigma_sq5)^(3/2))) * wHvar, FUN = "*"),
    Zvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(Xvar, MARGIN = 1,
    STATS = -(S * prC * sigx4w10z * sigx1_5 * ewz2/((sigma_sq5)^(3/2))) * wHvar,
    FUN = "*"), Zvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = -(S * prC * sigx4w11z * sigx1_5 * ewz3/((sigma_sq5)^(3/2))) *
      wHvar, FUN = "*"), Zvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 4 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = -(S * prC * sigx4w12z * sigx1_5 * ewz4/((sigma_sq5)^(3/2))) *
      wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 4 * nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = 2 *
    (((ewu5 * (S * (0.5 * sigx15_5 - (0.5 * (S^2 * sqewu5 * depsisq5 * (epsilon5)^2/(sigma_sq5)^2) -
      (((0.5 * (ewu5/(sigma_sq5)) + 1 - 0.5 * (0.5 * (wusq5) + ewu5/(sigma_sq5))) *
        (wusq5) * ewv5/sigmastar5 + (2 - 2 * (sigx2_5^2 * ewu5 * (sigma_sq5)/sqsq5^2)) *
        sigmastar5)/sqsq5^2 + S^2 * sqewu5^2 * ewu5 * (epsilon5)^2/sqsq5) *
        depsisq5) * dmusig5) * (epsilon5) - 0.5 * sigx12_5) + S * sigx11_5 *
      (epsilon5) - 0.5 * dpsq5)/(sigwz5) - sigx4w13z * ewu5 * sigx6_5/(sigwz5)^2) *
      prC * ewu5) * wHvar, FUN = "*"), uHvar)
  hessll[(5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = 2 *
    (((S * (((((0.5 * ((wusq5) * ewv5) - S^2 * sigx3_5 * sqewu5 * ewu5 * (epsilon5)^2)/(sigma_sq5) +
      0.5 * ((ewu5/(sigma_sq5) - 1) * ewv5/(sigma_sq5) + 1 - 0.5 * ((wusq5) *
        (wvsq5)))) * depsisq5/sigmastar5 + 0.5 * (S^2 * sigx3_5 * depsisq5 *
      (epsilon5)^2/(sigma_sq5)^2)) * ewu5 + sigx3_5 * (1 - 2 * (sigx2_5 * ewu5 *
      s3xq5)) * depsisq5) * dmusig5/sqsq5^2 + 0.5 * sigx15_5) * (epsilon5) -
      0.5 * sigx12_5)/(sigwz5) - sigx4w13z * sigx7_5/(sigwz5)^2) * prC * ewu5 *
      ewv5) * wHvar, FUN = "*"), vHvar)
  hessll[(5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar + nZHvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(prC *
    sigx4w9z * ewu5 * ewz1 * sigx6_5/sqrt(sigma_sq5)) * wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(uHvar, MARGIN = 1,
    STATS = -(prC * sigx4w10z * ewu5 * ewz2 * sigx6_5/sqrt(sigma_sq5)) * wHvar,
    FUN = "*"), Zvar)
  hessll[(5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = -(prC * sigx4w11z * ewu5 * ewz3 * sigx6_5/sqrt(sigma_sq5)) *
      wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    4 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = -(prC * sigx4w12z * ewu5 * ewz4 * sigx6_5/sqrt(sigma_sq5)) *
      wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    ...
    (((S * ((((0.5 * (ewv5/(sigma_sq5)) - 0.5 * (0.5 * (wvsq5) + ewv5/(sigma_sq5))) *
      (wvsq5) + S^2 * sigx3_5^2 * ewu5 * ewv5 * (epsilon5)^2/(sqsq5^2 * (sigma_sq5))) *
      depsisq5 * ewu5/sigmastar5 + ((0.5 * (S^2 * depsisq5 * (epsilon5)^2/(sigma_sq5)^2) -
      2 * (sigx3_5 * depsisq5 * s3xq5)) * ewv5 + depsisq5) * sigx3_5) * dmusig5 *
      ewu5/sqsq5^2 + S * (0.5 * (ewv5 * sigx19_5) + 0.5 * pmusig5) * depsisq5 *
      (epsilon5)/(sigma_sq5)^2) * (epsilon5) - (0.5 * (depsisq5 * pmusig5) +
      0.5 * (ewv5 * sigx13_5))/(sigma_sq5))/(sigwz5) - (0.5 * (sigx4/sqrt(sigma_sq5)) +
      2 * (prC * sigx7_5)) * ewv5 * sigx7_5/(sigwz5)^2) * prC * ewv5) * wHvar,
    FUN = "*"), vHvar)
  hessll[(5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar + nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(prC *
    sigx4w9z * ewv5 * ewz1 * sigx7_5/sqrt(sigma_sq5)) * wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1,
    STATS = -(prC * sigx4w10z * ewv5 * ewz2 * sigx7_5/sqrt(sigma_sq5)) * wHvar,
    FUN = "*"), Zvar)
  hessll[(5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = -(prC * sigx4w11z * ewv5 * ewz3 * sigx7_5/sqrt(sigma_sq5)) *
      wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 5 * nuZUvar + 4 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar + 1):(5 *
    nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = -(prC * sigx4w12z * ewv5 * ewz4 * sigx7_5/sqrt(sigma_sq5)) *
      wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar + nZHvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + nZHvar)] <- crossprod(sweep(Zvar, MARGIN = 1,
    STATS = ((1 - ewz1/wzdeno)/wzdsig - 2 * (dwp1/dwz1)) * sigx4w15z * ewz1 *
      wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar + nZHvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar +
    1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(Zvar,
    MARGIN = 1, STATS = -((sigx4w15z/(sigx4wzsq) + 2 * (sigx4w16z * dwzep1)) *
      ewz1 * ewz2) * wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar + nZHvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar +
    1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(Zvar,
    MARGIN = 1, STATS = -((sigx4w15z/(sigx4wzsq) + 2 * (sigx4w17z * dwzep1)) *
      ewz1 * ewz3) * wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 1):(5 * nXvar + 5 * nuZUvar +
    5 * nvZVvar + nZHvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar +
    1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(Zvar,
    MARGIN = 1, STATS = -((sigx4w15z/(sigx4wzsq) + 2 * (sigx4w18z * dwzep1)) *
      ewz1 * ewz4) * wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar + 2 * nZHvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar +
    nZHvar + 1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(Zvar,
    MARGIN = 1, STATS = ((1 - ewz2/wzdeno)/wzdsig - 2 * (dwp2/dwz2)) * sigx4w16z *
      ewz2 * wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar + 2 * nZHvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar +
    2 * nZHvar + 1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(Zvar,
    MARGIN = 1, STATS = -((sigx4w16z/(sigx4wzsq) + 2 * (sigx4w17z * dwzep2)) *
      ewz2 * ewz3) * wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + nZHvar + 1):(5 * nXvar + 5 *
    nuZUvar + 5 * nvZVvar + 2 * nZHvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar +
    3 * nZHvar + 1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(Zvar,
    MARGIN = 1, STATS = -((sigx4w16z/(sigx4wzsq) + 2 * (sigx4w18z * dwzep2)) *
      ewz2 * ewz4) * wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar +
    2 * nZHvar + 1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(Zvar,
    MARGIN = 1, STATS = ((1 - ewz3/wzdeno)/wzdsig - 2 * (dwp3/dwz3)) * sigx4w17z *
      ewz3 * wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 2 * nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar +
    3 * nZHvar + 1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(Zvar,
    MARGIN = 1, STATS = -((sigx4w17z/(sigx4wzsq) + 2 * (sigx4w18z * dwzep3)) *
      ewz3 * ewz4) * wHvar, FUN = "*"), Zvar)
  hessll[(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 3 * nZHvar + 1):(5 * nXvar +
    5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar), (5 * nXvar + 5 * nuZUvar + 5 * nvZVvar +
    3 * nZHvar + 1):(5 * nXvar + 5 * nuZUvar + 5 * nvZVvar + 4 * nZHvar)] <- crossprod(sweep(Zvar,
    MARGIN = 1, STATS = ((1 - ewz4/wzdeno)/wzdsig - 2 * (dwp4/dwz4)) * sigx4w18z *
      ewz4 * wHvar, FUN = "*"), Zvar)
...
#' @noRd
LCM5ChnormAlgOpt <- function(start, randStart, sdStart, olsParam, dataTable, S, wHvar,
  nXvar, uHvar, nuZUvar, vHvar, nvZVvar, Zvar, nZHvar, Yvar, Xvar, method, printInfo,
  ...
  startLoglik <- sum(cLCMhalfnormlike5C(startVal, nXvar = nXvar, nuZUvar = nuZUvar,
  ...
  mleObj <- switch(method, ucminf = ucminf::ucminf(par = startVal, fn = function(parm) -sum(cLCMhalfnormlike5C(parm,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar,
    Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)),
    gr = function(parm) -colSums(cgradLCMhalfnormlike5C(parm, nXvar = nXvar,
    ...
    control = list(trace = if (printInfo) 1 else 0, maxeval = itermax, stepmax = stepmax,
      xtol = tol, grtol = gradtol)), maxLikAlgo = maxRoutine(fn = cLCMhalfnormlike5C,
    grad = cgradLCMhalfnormlike5C, hess = chessLCMhalfnormlike5C, start = startVal,
    ...
    fn = function(parm) -sum(cLCMhalfnormlike5C(parm, nXvar = nXvar, nuZUvar = nuZUvar,
      nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradLCMhalfnormlike5C(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar,
      Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)),
    ...
    sparse = trustOptim::trust.optim(x = startVal, fn = function(parm) -sum(cLCMhalfnormlike5C(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar,
      Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)),
      gr = function(parm) -colSums(cgradLCMhalfnormlike5C(parm, nXvar = nXvar,
        nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar,
        Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)),
      hs = function(parm) as(-chessLCMhalfnormlike5C(parm, nXvar = nXvar, nuZUvar = nuZUvar,
        nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      ...
      method = "Sparse", control = list(maxit = itermax, cgtol = gradtol, stop.trust.radius = tol,
        prec = tol, report.level = if (printInfo) 2 else 0, report.precision = 1L,
        preconditioner = 1L)), mla = marqLevAlg::mla(b = startVal, fn = function(parm) -sum(cLCMhalfnormlike5C(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar,
      Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)),
      gr = function(parm) -colSums(cgradLCMhalfnormlike5C(parm, nXvar = nXvar,
        nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar,
        Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)),
      hess = function(parm) -chessLCMhalfnormlike5C(parm, nXvar = nXvar, nuZUvar = nuZUvar,
        nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      ...
      objective = function(parm) -sum(cLCMhalfnormlike5C(parm, nXvar = nXvar,
        nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar,
        Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)),
      gradient = function(parm) -colSums(cgradLCMhalfnormlike5C(parm, nXvar = nXvar,
        nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar,
        Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)),
      hessian = function(parm) -chessLCMhalfnormlike5C(parm, nXvar = nXvar,
        nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar,
        Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar),
      control = list(iter.max = itermax, trace = if (printInfo) 1 else 0, eval.max = itermax,
        rel.tol = tol, x.tol = tol)))
  if (method %in% c("ucminf", "nlminb")) {
    mleObj$gradient <- colSums(cgradLCMhalfnormlike5C(mleObj$par, nXvar = nXvar,
      nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar, Yvar = Yvar,
  ...
  if (hessianType != 2) {
    if (method %in% c("ucminf", "nlminb"))
      mleObj$hessian <- chessLCMhalfnormlike5C(parm = mleObj$par, nXvar = nXvar,
        nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar,
        Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)
    if (method == "sr1")
      mleObj$hessian <- chessLCMhalfnormlike5C(parm = mleObj$solution, nXvar = nXvar,
        nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar,
        Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)
  }
  mleObj$logL_OBS <- cLCMhalfnormlike5C(parm = mlParam, nXvar = nXvar, nuZUvar = nuZUvar,
    nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)
  mleObj$gradL_OBS <- cgradLCMhalfnormlike5C(parm = mlParam, nXvar = nXvar, nuZUvar = nuZUvar,
    nvZVvar = nvZVvar, uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, Zvar = Zvar, nZHvar = nZHvar)
...
cmargLCM5Chalfnorm_Eu <- function(object) {
  ...
  margEff_c5 <- kronecker(matrix(delta5[2:object$nuZUvar], nrow = 1), matrix(exp(Wu5/2) *
    dnorm(0), ncol = 1))
...
cmargLCM5Chalfnorm_Vu <- function(object) {
  ...
  margEff_c5 <- kronecker(matrix(delta5[2:object$nuZUvar], nrow = 1), matrix(exp(Wu5) *
    (1 - (dnorm(0)/pnorm(0))^2), ncol = 1))
