...
czisftruncnormlike_logit <- function(parm, nXvar, nmuZUvar, nuZUvar,
...
czisftruncnormlike_cauchit <- function(parm, nXvar, nmuZUvar,
...
czisftruncnormlike_probit <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
...
czisftruncnormlike_cloglog <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
...
## logit specification class membership
cmnsftruncnormlike_logit <- function(parm, nXvar, nmuZUvar, nuZUvar,
  nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar, Zvar,
  nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
...
## cauchit specification class membership
cmnsftruncnormlike_cauchit <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
...
## probit specification class membership
cmnsftruncnormlike_probit <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
...
## cloglog specification class membership
cmnsftruncnormlike_cloglog <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
...
## logit specification class membership
cgradzisftruncnormlike_logit <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
...
## cauchit specification class membership
cgradzisftruncnormlike_cauchit <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
  ...
  gradll <- cbind(sweep(Xvar, MARGIN = 1, STATS = S * sigx4/sigx3,
    FUN = "*"), sweep(muHvar, MARGIN = 1, STATS = sigx7 *
    ewz1/sigx3, FUN = "*"), sweep(uHvar, MARGIN = 1, STATS = sigx13 *
...
## probit specification class membership
cgradzisftruncnormlike_probit <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
  ...
  gradll <- cbind(sweep(Xvar, MARGIN = 1, STATS = S * sigx4/sigx3,
    FUN = "*"), sweep(muHvar, MARGIN = 1, STATS = sigx7 *
    pwZ/sigx3, FUN = "*"), sweep(uHvar, MARGIN = 1, STATS = sigx13 *
...
## cloglog specification class membership
cgradzisftruncnormlike_cloglog <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
  ...
  gradll <- cbind(sweep(Xvar, MARGIN = 1, STATS = S * sigx4/sigx3,
    FUN = "*"), sweep(muHvar, MARGIN = 1, STATS = sigx7 *
    (1 - prZ)/sigx3, FUN = "*"), sweep(uHvar, MARGIN = 1,
    STATS = sigx13 * (1 - prZ)/sigx3, FUN = "*"), sweep(vHvar,
    MARGIN = 1, STATS = sigx16/sigx3, FUN = "*"), sweep(Zvar,
    MARGIN = 1, STATS = sigx17 * prZ * ewz/sigx3, FUN = "*"))
  return(sweep(gradll, MARGIN = 1, STATS = wHvar, FUN = "*"))
}
...
## logit specification class membership
cgradmnsftruncnormlike_logit <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
...
## cauchit specification class membership
cgradmnsftruncnormlike_cauchit <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
  ...
  gradll <- cbind(sweep(Xvar, MARGIN = 1, STATS = S * sigx4/sigx2,
    FUN = "*"), sweep(muHvar, MARGIN = 1, STATS = sigx7 *
    ewz1/sigx2, FUN = "*"), sweep(uHvar, MARGIN = 1, STATS = sigx13 *
...
## probit specification class membership
cgradmnsftruncnormlike_probit <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
  ...
  gradll <- cbind(sweep(Xvar, MARGIN = 1, STATS = S * sigx4/sigx2,
    FUN = "*"), sweep(muHvar, MARGIN = 1, STATS = sigx7 *
    pwZ/sigx2, FUN = "*"), sweep(uHvar, MARGIN = 1, STATS = sigx13 *
...
## cloglog specification class membership
cgradmnsftruncnormlike_cloglog <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
  ...
  gradll <- cbind(sweep(Xvar, MARGIN = 1, STATS = S * sigx4/sigx2,
    ...
    STATS = sigx13 * (1 - prZ)/sigx2, FUN = "*"), sweep(vHvar,
    MARGIN = 1, STATS = (sigx15/pwu - 0.5 * sigx16) * (1 -
      prZ) * ewv1/(sigx2 * sqrt(sigma_sq)), FUN = "*"),
    sweep(vHvar, MARGIN = 1, STATS = sigx17 * prZ/(sigx2 *
      ewvsr2), FUN = "*"), sweep(Zvar, MARGIN = 1, STATS = sigx18 *
      prZ * ewz/sigx2, FUN = "*"))
  return(sweep(gradll, MARGIN = 1, STATS = wHvar, FUN = "*"))
}
...
## logit specification class membership
chesszisftruncnormlike_logit <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
...
## cauchit specification class membership
chesszisftruncnormlike_cauchit <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
  ...
  hessll[1:nXvar, (nXvar + 1):(nXvar + nmuZUvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = wHvar * S * (((dmu * (dmusig * muepsi -
      dmusig * (mu * ewv - S * ewu * (epsilon))/ewv) *
      ewv/(ssq) - ((muepsi^2/(sigma_sq) - 1) * pmusig +
      dmu * ewu * muepsi/(ssq)) * dmusig)/sigx12 - sigx2 *
      dwu * sqrt(sigma_sq)/sigx6)/(sigma_sq) - sigx4 *
      sigx7/sigx3) * ewz1/sigx3, FUN = "*"), muHvar)
  hessll[1:nXvar, (nXvar + nmuZUvar + 1):(nXvar + nmuZUvar +
    nuZUvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = wHvar *
    S * ((0.5 * (((muepsi^2/(sigma_sq) - 2) * pmusig + dmu *
    ewu * muepsi/(ssq)) * dmusig * muepsi/(sigma_sq)^2) -
    (sigx9 * dmusig * muepsi/(sigma_sq) + (sigx8 * ewu/(ssq)^2 -
      (sigx9 * (mu * ewv - S * ewu * (epsilon))/ewv + 1/sigmastar)/(sigma_sq)) *
      dmusig) * dmu) * ewu/sigx12 - (sigx13 * sigx4/sigx3 +
    sigx10 * sigx2/((sigma_sq) * sigx12^2))) * ewz1/sigx3,
    FUN = "*"), uHvar)
  hessll[1:nXvar, (nXvar + nmuZUvar + nuZUvar + 1):(nXvar +
    nmuZUvar + nuZUvar + nvZVvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = wHvar * S * (((((dmusig * muepsi -
      dmusig * (mu * ewv - S * ewu * (epsilon))/ewv) *
      sigx1/(sigma_sq) - s2sig * dmusig * ewu/(ssq)^2) *
      dmu + 0.5 * (((muepsi^2/(sigma_sq) - 2) * pmusig +
      dmu * ewu * muepsi/(ssq)) * dmusig * muepsi/(sigma_sq)^2))/pwu -
      0.5 * (sigx2 * pwu/((sigma_sq) * sigx12^2))) * ewz1 *
      ewv/sqrt(sigma_sq) + S * ewz2 * (0.5 * (S^2 * (epsilon)^2/ewvsr^2 -
      2) - 0.5) * depsi * (epsilon)/ewvsr^3 - sigx16 *
  ...
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + 1):(nXvar +
    nmuZUvar)] <- crossprod(sweep(muHvar, MARGIN = 1, STATS = -wHvar *
    (((((1 - muepsi^2/(sigma_sq)) * pmusig + dmu * ewv *
      muepsi/(ssq)) * dmusig + dmu * (dmusig * (mu * ewv -
      S * ewu * (epsilon))/ewu + dmusig * muepsi) * ewv/(ssq))/pssq +
      ((sigx5/(pssq^2 * ewusr) - 2 * (dmusig * dwu * pmusig *
        pwu/sigx6^2)) * (sigma_sq) + (dmu * dmusig *
        ewv/(ssq) - (dmusig * muepsi/(sigma_sq) + mu *
        dmusig/ewusr^2) * pmusig)/sigx6) * dwu * sqrt(sigma_sq) +
      sigx7^2 * ewz1/sigx3) * ewz1/sigx3), FUN = "*"),
    muHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    1):(nXvar + nmuZUvar + nuZUvar)] <- crossprod(sweep(muHvar,
    MARGIN = 1, STATS = wHvar * (((0.5 * (((2 - muepsi^2/(sigma_sq)) *
      pmusig + dmu * ewv * muepsi/(ssq)) * dmusig * muepsi/(sigma_sq)^2) -
      ((sigx8 * ewv/(ssq)^2 - sigx9 * (mu * ewv - S * ewu *
        (epsilon))/(ewu * (sigma_sq))) * dmusig - sigx9 *
        dmusig * muepsi/(sigma_sq)) * dmu)/sigx12 - sigx11 *
      dwu * sqrt(sigma_sq)/sigx6) * ewu - ((((0.5 * (ewu/sqrt(sigma_sq)) -
      0.5 * ((1 - mu^2/ewusr^2) * sqrt(sigma_sq))) * dmusig *
      dwu/ewusr - sigx10 * dmusig * muepsi/(sigma_sq)) *
      pmusig + sigx10 * (dmu * ewv/(ssq) - 2 * (dwu * (sigma_sq) *
      pmusig * pwu/sigx6)) * dmusig)/sigx12^2 + sigx13 *
      sigx7 * ewz1/sigx3)) * ewz1/sigx3, FUN = "*"), uHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    nuZUvar + 1):(nXvar + nmuZUvar + nuZUvar + nvZVvar)] <- crossprod(sweep(muHvar,
    MARGIN = 1, STATS = wHvar * (((((1/(ssq) - s2sig * ewv/(ssq)^2) *
      dmusig - (dmusig * (mu * ewv - S * ewu * (epsilon))/ewu +
      dmusig * muepsi) * sigx1/(sigma_sq)) * dmu + 0.5 *
      (((2 - muepsi^2/(sigma_sq)) * pmusig + dmu * ewv *
        muepsi/(ssq)) * dmusig * muepsi/(sigma_sq)^2) -
      (0.5 * dpmu + dmu * dmusig * sigx1) * dwu/(ewusr *
        pwu))/pwu - 0.5 * (((1 - 2 * ((sigma_sq) * pwu^2/sigx12^2)) *
      dmusig * dwu * pmusig/ewusr + sigx5 * pwu/(sigma_sq))/sigx12^2)) *
      ewv/sqrt(sigma_sq) - sigx16 * sigx7/sigx3) * ewz1/sigx3,
    FUN = "*"), vHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    nuZUvar + nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    nvZVvar + nZHvar)] <- crossprod(sweep(muHvar, MARGIN = 1,
    STATS = wHvar * sigx7 * (1/(pi * sigx3 * ((Wz)^2 + 1)) -
      pi * ((Wz)^2 + 1) * ewz1 * sigx17/(pi * sigx3 * ((Wz)^2 +
        1))^2), FUN = "*"), Zvar)
  hessll[(nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar),
    (nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = wHvar * ((((0.5 * (((0.5 * (muepsi^2/(sigma_sq)) -
      2) * pmusig/(sigma_sq) - sigx9 * dmu) * ewu) + 0.5 *
      pmusig) * dmusig * muepsi^2/(sigma_sq)^2 - ((sigx9^2 *
      ewu * (mu * ewv - S * ewu * (epsilon))/(ssq) + ((0.5 *
      (ewu/(sigma_sq)) - 0.5 * (0.5 * (1 - ewu/(sigma_sq)) +
      ewu/(sigma_sq))) * (1 - ewu/(sigma_sq)) * ewv * (mu *
      ewv - S * ewu * (epsilon))/sigmastar - sigx8 * (2 *
      (sigx8 * (sigma_sq) * (mu * ewv - S * ewu * (epsilon)) *
        sigmastar/(ssq)^2) + 2 * (S * (epsilon))) * ewu)/(ssq)^2) *
      dmusig + sigx9 * (0.5 * (dmusig * ewu * muepsi^2/(sigma_sq)^2) +
  ...
  hessll[(nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar),
    (nXvar + nmuZUvar + nuZUvar + 1):(nXvar + nmuZUvar +
      nuZUvar + nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1,
    STATS = wHvar * ((((((sigx9 * dmusig * (mu * ewv - S *
      ewu * (epsilon))/sigmastar + 0.5 * (dmusig * muepsi^2/(sigma_sq))) *
      sigx1/(sigma_sq) - ((0.5 * ((1 - ewu/(sigma_sq)) *
      ewv/(sigma_sq)) + 0.5 * ((ewu/(sigma_sq) - 1) * ewv/(sigma_sq) +
      1 - 0.5 * ((1 - ewu/(sigma_sq)) * prV))) * (mu *
      ewv - S * ewu * (epsilon))/sigmastar + mu * sigx8 -
      s2sig * (2 * (sigx8 * (sigma_sq) * (mu * ewv - S *
        ewu * (epsilon)) * sigmastar/(ssq)^2) + S * (epsilon))) *
      dmusig/(ssq)^2) * dmu + 0.5 * (((0.5 * (muepsi^2/(sigma_sq)) -
      2) * pmusig/(sigma_sq) - sigx9 * dmu) * dmusig *
      muepsi^2/(sigma_sq)^2)) * ewu + 0.5 * (mu * (0.5 *
      dpmu + dmu * dmusig * sigx1) * dwu/(ewusr * pwu)))/pwu -
      (0.5 * ((sigx11 * ewu * pwu - (0.5 * (mu * dwu/ewusr) +
        2 * (sigx10 * pwu^2 * sqrt(sigma_sq)/sigx12^2)) *
        dmusig * pmusig)/sigx12^2) + 0.5 * (sigx14 *
        ewu/(sigma_sq)))) * ewv/sqrt(sigma_sq) - sigx16 *
      sigx13/sigx3) * ewz1/sigx3, FUN = "*"), vHvar)
  hessll[(nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar),
    (nXvar + nmuZUvar + nuZUvar + nvZVvar + 1):(nXvar + nmuZUvar +
      nuZUvar + nvZVvar + nZHvar)] <- crossprod(sweep(uHvar,
  ...
  hessll[(nXvar + nmuZUvar + nuZUvar + 1):(nXvar + nmuZUvar +
    nuZUvar + nvZVvar), (nXvar + nmuZUvar + nuZUvar + nvZVvar +
    1):(nXvar + nmuZUvar + nuZUvar + nvZVvar + nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = wHvar * ((sigx14 * ewv/sqrt(sigma_sq) -
      sigx15/ewvsr)/(pi * sigx3 * ((Wz)^2 + 1)) - pi *
      sigx16 * ((Wz)^2 + 1) * sigx17/(pi * sigx3 * ((Wz)^2 +
      1))^2), FUN = "*"), Zvar)
  hessll[(nXvar + nmuZUvar + nuZUvar + nvZVvar + 1):(nXvar +
    nmuZUvar + nuZUvar + nvZVvar + nZHvar), (nXvar + nmuZUvar +
    nuZUvar + nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    nvZVvar + nZHvar)] <- crossprod(sweep(Zvar, MARGIN = 1,
    STATS = -wHvar * ((2 * (pi * Wz * sigx3) + dmusig * pmusig/sigx12 -
      depsi/ewvsr) * sigx17/(pi * sigx3 * ((Wz)^2 + 1))^2),
    FUN = "*"), Zvar)
  hessll[lower.tri(hessll)] <- t(hessll)[lower.tri(hessll)]
  # hessll<-(hessll+(hessll))/2
  return(hessll)
...
## probit specification class membership
chesszisftruncnormlike_probit <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
  ...
  hessll[1:nXvar, (nXvar + 1):(nXvar + nmuZUvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = wHvar * S * (((dmu * (dmusig * muepsi -
      ...
      dmu * ewu * muepsi/(ssq)) * dmusig)/sigx12 - sigx2 *
      dwu * sqrt(sigma_sq)/sigx6)/(sigma_sq) - sigx4 *
      sigx7/sigx3) * pwZ/sigx3, FUN = "*"), muHvar)
  hessll[1:nXvar, (nXvar + nmuZUvar + 1):(nXvar + nmuZUvar +
    nuZUvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = wHvar *
    S * ((0.5 * (((muepsi^2/(sigma_sq) - 2) * pmusig + dmu *
    ewu * muepsi/(ssq)) * dmusig * muepsi/(sigma_sq)^2) -
    (sigx9 * dmusig * muepsi/(sigma_sq) + (sigx8 * ewu/(ssq)^2 -
      (sigx9 * (mu * ewv - S * ewu * (epsilon))/ewv + 1/sigmastar)/(sigma_sq)) *
      dmusig) * dmu) * ewu/sigx12 - (sigx13 * sigx4/sigx3 +
    sigx10 * sigx2/((sigma_sq) * sigx12^2))) * pwZ/sigx3,
    FUN = "*"), uHvar)
  hessll[1:nXvar, (nXvar + nmuZUvar + nuZUvar + 1):(nXvar +
    nmuZUvar + nuZUvar + nvZVvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = wHvar * S * (((((dmusig * muepsi -
      ...
      2) - 0.5) * (1 - pwZ) * depsi * (epsilon)/ewvsr^3 -
  ...
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + 1):(nXvar +
    ...
    (((((1 - muepsi^2/(sigma_sq)) * pmusig + dmu * ewv *
      ...
      ((sigx5/(pssq^2 * ewusr) - 2 * (dmusig * dwu * pmusig *
        ...
        ewv/(ssq) - (dmusig * muepsi/(sigma_sq) + mu *
        dmusig/ewusr^2) * pmusig)/sigx6) * dwu * sqrt(sigma_sq) +
      sigx7^2 * pwZ/sigx3) * pwZ/sigx3), FUN = "*"), muHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    1):(nXvar + nmuZUvar + nuZUvar)] <- crossprod(sweep(muHvar,
    MARGIN = 1, STATS = wHvar * (((0.5 * (((2 - muepsi^2/(sigma_sq)) *
      pmusig + dmu * ewv * muepsi/(ssq)) * dmusig * muepsi/(sigma_sq)^2) -
      ...
      pmusig + sigx10 * (dmu * ewv/(ssq) - 2 * (dwu * (sigma_sq) *
      pmusig * pwu/sigx6)) * dmusig)/sigx12^2 + sigx13 *
      sigx7 * pwZ/sigx3)) * pwZ/sigx3, FUN = "*"), uHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    nuZUvar + 1):(nXvar + nmuZUvar + nuZUvar + nvZVvar)] <- crossprod(sweep(muHvar,
    MARGIN = 1, STATS = wHvar * (((((1/(ssq) - s2sig * ewv/(ssq)^2) *
      dmusig - (dmusig * (mu * ewv - S * ewu * (epsilon))/ewu +
      ...
      (0.5 * dpmu + dmu * dmusig * sigx1) * dwu/(ewusr *
        pwu))/pwu - 0.5 * (((1 - 2 * ((sigma_sq) * pwu^2/sigx12^2)) *
      dmusig * dwu * pmusig/ewusr + sigx5 * pwu/(sigma_sq))/sigx12^2)) *
      ewv/sqrt(sigma_sq) - sigx16 * sigx7/sigx3) * pwZ/sigx3,
    FUN = "*"), vHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    nuZUvar + nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    nvZVvar + nZHvar)] <- crossprod(sweep(muHvar, MARGIN = 1,
    STATS = wHvar * sigx7 * (1 - sigx17 * pwZ/sigx3) * dwZ/sigx3,
    FUN = "*"), Zvar)
  hessll[(nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar),
    (nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = wHvar * ((((0.5 * (((0.5 * (muepsi^2/(sigma_sq)) -
  ...
  hessll[(nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar),
    ...
    STATS = wHvar * ((((((sigx9 * dmusig * (mu * ewv - S *
      ...
      (0.5 * ((sigx11 * ewu * pwu - (0.5 * (mu * dwu/ewusr) +
        ...
        dmusig * pmusig)/sigx12^2) + 0.5 * (sigx14 *
        ewu/(sigma_sq)))) * ewv/sqrt(sigma_sq) - sigx16 *
      sigx13/sigx3) * pwZ/sigx3, FUN = "*"), vHvar)
  hessll[(nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar),
    (nXvar + nmuZUvar + nuZUvar + nvZVvar + 1):(nXvar + nmuZUvar +
      nuZUvar + nvZVvar + nZHvar)] <- crossprod(sweep(uHvar,
  ...
  hessll[(nXvar + nmuZUvar + nuZUvar + 1):(nXvar + nmuZUvar +
    ...
    1):(nXvar + nmuZUvar + nuZUvar + nvZVvar + nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = wHvar * (sigx14 * ewv/sqrt(sigma_sq) -
      (sigx16 * sigx17/sigx3 + sigx15/ewvsr)) * dwZ/sigx3,
    FUN = "*"), Zvar)
  hessll[(nXvar + nmuZUvar + nuZUvar + nvZVvar + 1):(nXvar +
    nmuZUvar + nuZUvar + nvZVvar + nZHvar), (nXvar + nmuZUvar +
    nuZUvar + nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    nvZVvar + nZHvar)] <- crossprod(sweep(Zvar, MARGIN = 1,
    STATS = -wHvar * ((sigx17 * dwZ/sigx3 + Wz) * sigx17 *
      dwZ/sigx3), FUN = "*"), Zvar)
  hessll[lower.tri(hessll)] <- t(hessll)[lower.tri(hessll)]
  # hessll<-(hessll+(hessll))/2
  return(hessll)
...
## cloglog specification class membership
chesszisftruncnormlike_cloglog <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
  ...
  hessll[1:nXvar, (nXvar + 1):(nXvar + nmuZUvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = wHvar * S * (((dmu * (dmusig * muepsi -
      ...
      dmu * ewu * muepsi/(ssq)) * dmusig)/sigx12 - sigx2 *
      dwu * sqrt(sigma_sq)/sigx6)/(sigma_sq) - sigx4 *
      sigx7/sigx3) * (1 - prZ)/sigx3, FUN = "*"), muHvar)
  hessll[1:nXvar, (nXvar + nmuZUvar + 1):(nXvar + nmuZUvar +
    nuZUvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = wHvar *
    S * ((0.5 * (((muepsi^2/(sigma_sq) - 2) * pmusig + dmu *
    ewu * muepsi/(ssq)) * dmusig * muepsi/(sigma_sq)^2) -
    (sigx9 * dmusig * muepsi/(sigma_sq) + (sigx8 * ewu/(ssq)^2 -
      (sigx9 * (mu * ewv - S * ewu * (epsilon))/ewv + 1/sigmastar)/(sigma_sq)) *
      dmusig) * dmu) * ewu/sigx12 - (sigx13 * sigx4/sigx3 +
    sigx10 * sigx2/((sigma_sq) * sigx12^2))) * (1 - prZ)/sigx3,
    FUN = "*"), uHvar)
  hessll[1:nXvar, (nXvar + nmuZUvar + nuZUvar + 1):(nXvar +
    nmuZUvar + nuZUvar + nvZVvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = wHvar * S * (((((dmusig * muepsi -
      ...
      dmu + 0.5 * (((muepsi^2/(sigma_sq) - 2) * pmusig +
      dmu * ewu * muepsi/(ssq)) * dmusig * muepsi/(sigma_sq)^2))/pwu -
      0.5 * (sigx2 * pwu/((sigma_sq) * sigx12^2))) * (1 -
      prZ) * ewv/sqrt(sigma_sq) + S * (0.5 * (S^2 * (epsilon)^2/ewvsr^2 -
  ...
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + 1):(nXvar +
    ...
    (((((1 - muepsi^2/(sigma_sq)) * pmusig + dmu * ewv *
      ...
      ((sigx5/(pssq^2 * ewusr) - 2 * (dmusig * dwu * pmusig *
        ...
        ewv/(ssq) - (dmusig * muepsi/(sigma_sq) + mu *
        dmusig/ewusr^2) * pmusig)/sigx6) * dwu * sqrt(sigma_sq) +
      sigx7^2 * (1 - prZ)/sigx3) * (1 - prZ)/sigx3), FUN = "*"),
    muHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    1):(nXvar + nmuZUvar + nuZUvar)] <- crossprod(sweep(muHvar,
    MARGIN = 1, STATS = wHvar * (((0.5 * (((2 - muepsi^2/(sigma_sq)) *
      ...
      pmusig + sigx10 * (dmu * ewv/(ssq) - 2 * (dwu * (sigma_sq) *
      pmusig * pwu/sigx6)) * dmusig)/sigx12^2 + sigx13 *
      sigx7 * (1 - prZ)/sigx3)) * (1 - prZ)/sigx3, FUN = "*"),
    uHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    nuZUvar + 1):(nXvar + nmuZUvar + nuZUvar + nvZVvar)] <- crossprod(sweep(muHvar,
    MARGIN = 1, STATS = wHvar * (((((1/(ssq) - s2sig * ewv/(ssq)^2) *
      ...
      (0.5 * dpmu + dmu * dmusig * sigx1) * dwu/(ewusr *
        pwu))/pwu - 0.5 * (((1 - 2 * ((sigma_sq) * pwu^2/sigx12^2)) *
      dmusig * dwu * pmusig/ewusr + sigx5 * pwu/(sigma_sq))/sigx12^2)) *
      ewv/sqrt(sigma_sq) - sigx16 * sigx7/sigx3) * (1 -
      prZ)/sigx3, FUN = "*"), vHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    nuZUvar + nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    nvZVvar + nZHvar)] <- crossprod(sweep(muHvar, MARGIN = 1,
    STATS = wHvar * sigx7 * (1 - (1 - prZ) * sigx17/sigx3) *
      prZ * ewz/sigx3, FUN = "*"), Zvar)
  hessll[(nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar),
    (nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = wHvar * ((((0.5 * (((0.5 * (muepsi^2/(sigma_sq)) -
  ...
  hessll[(nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar),
    ...
    STATS = wHvar * ((((((sigx9 * dmusig * (mu * ewv - S *
      ...
      (0.5 * ((sigx11 * ewu * pwu - (0.5 * (mu * dwu/ewusr) +
        ...
        dmusig * pmusig)/sigx12^2) + 0.5 * (sigx14 *
        ewu/(sigma_sq)))) * ewv/sqrt(sigma_sq) - sigx16 *
      sigx13/sigx3) * (1 - prZ)/sigx3, FUN = "*"), vHvar)
  hessll[(nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar),
    (nXvar + nmuZUvar + nuZUvar + nvZVvar + 1):(nXvar + nmuZUvar +
      nuZUvar + nvZVvar + nZHvar)] <- crossprod(sweep(uHvar,
  ...
  hessll[(nXvar + nmuZUvar + nuZUvar + 1):(nXvar + nmuZUvar +
    ...
    1):(nXvar + nmuZUvar + nuZUvar + nvZVvar + nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = wHvar * (sigx14 * ewv/sqrt(sigma_sq) -
      (sigx16 * sigx17/sigx3 + sigx15/ewvsr)) * prZ * ewz/sigx3,
    FUN = "*"), Zvar)
  hessll[(nXvar + nmuZUvar + nuZUvar + nvZVvar + 1):(nXvar +
    nmuZUvar + nuZUvar + nvZVvar + nZHvar), (nXvar + nmuZUvar +
    nuZUvar + nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    nvZVvar + nZHvar)] <- crossprod(sweep(Zvar, MARGIN = 1,
    STATS = wHvar * (1 - (sigx17 * prZ/sigx3 + 1) * ewz) *
      sigx17 * prZ * ewz/sigx3, FUN = "*"), Zvar)
  hessll[lower.tri(hessll)] <- t(hessll)[lower.tri(hessll)]
  # hessll<-(hessll+(hessll))/2
  return(hessll)
}
...
## logit specification class membership
chessmnsftruncnormlike_logit <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
...
## cauchit specification class membership
chessmnsftruncnormlike_cauchit <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
  ...
  hessll[1:nXvar, (nXvar + 1):(nXvar + nmuZUvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = wHvar * S * (((dmustar * (dmusig *
      muepsi - dmusig * muvu/ewv1) * ewv1/ssq - ((muepsi^2/(sigma_sq) -
      1) * pmustar + dmustar * ewu * muepsi/ssq) * dmusig)/(pwu *
      sqrt(sigma_sq)) - sigx1 * dwu * sqrt(sigma_sq)/sigx6)/(sigma_sq) -
      sigx4 * sigx7/sigx2) * ewz1/sigx2, FUN = "*"), muHvar)
  hessll[1:nXvar, (nXvar + nmuZUvar + 1):(nXvar + nmuZUvar +
    nuZUvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = wHvar *
    S * ((0.5 * (((muepsi^2/(sigma_sq) - 2) * pmustar + dmustar *
    ewu * muepsi/ssq) * dmusig * muepsi/(sigma_sq)^2) - (sigx10 *
    dmusig * muepsi/(sigma_sq) + (sigx9 * ewu/ssq^2 - (sigx10 *
    muvu/ewv1 + 1/sigmastar)/(sigma_sq)) * dmusig) * dmustar) *
    ewu/(pwu * sqrt(sigma_sq)) - (sigx13 * sigx4/sigx2 +
    sigx12 * sigx1/((sigma_sq) * (pwu * sqrt(sigma_sq))^2))) *
    ewz1/sigx2, FUN = "*"), uHvar)
  hessll[1:nXvar, (nXvar + nmuZUvar + nuZUvar + 1):(nXvar +
    nmuZUvar + nuZUvar + nvZVvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = wHvar * S * (((((dmusig * muepsi -
      dmusig * muvu/ewv1) * sigx14/(sigma_sq) - (0.5 *
      (prV * ewu/sigmastar) + sigmastar) * dmusig * ewu/ssq^2) *
      dmustar + 0.5 * (((muepsi^2/(sigma_sq) - 2) * pmustar +
      dmustar * ewu * muepsi/ssq) * dmusig * muepsi/(sigma_sq)^2))/pwu -
      0.5 * (sigx1 * pwu/((sigma_sq) * (pwu * sqrt(sigma_sq))^2)))/(sigx2 *
      sqrt(sigma_sq)) - (sigx15/pwu - 0.5 * sigx16) * sigx4 *
      sqrt(sigma_sq)/(sigx2 * sqrt(sigma_sq))^2) * ewz1 *
      ewv1, FUN = "*"), vHvar)
  hessll[1:nXvar, (nXvar + nmuZUvar + nuZUvar + nvZVvar + 1):(nXvar +
    nmuZUvar + nuZUvar + 2 * nvZVvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = wHvar * S * ewz2 * (S * (0.5 * (S^2 *
      (epsilon)^2/ewvsr2^2 - 2) - 0.5) * depsi * (epsilon)/(sigx2 *
      ewvsr2^3) - sigx4 * sigx17 * ewvsr2/(sigx2 * ewvsr2)^2),
    FUN = "*"), vHvar)
  hessll[1:nXvar, (nXvar + nmuZUvar + nuZUvar + 2 * nvZVvar +
    1):(nXvar + nmuZUvar + nuZUvar + 2 * nvZVvar + nZHvar)] <- crossprod(sweep(Xvar,
  ...
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + 1):(nXvar +
    ...
    (((((1 - muepsi^2/(sigma_sq)) * pmustar + dmustar * ewv1 *
      muepsi/ssq) * dmusig + dmustar * (dmusig * muvu/ewu +
      dmusig * muepsi) * ewv1/ssq)/sigx3 + ((sigx5/(sigx3^2 *
      ewusr) - 2 * (dmusig * dwu * pmustar * pwu/sigx6^2)) *
      (sigma_sq) + (dmustar * dmusig * ewv1/ssq - (dmusig *
      muepsi/(sigma_sq) + mu * dmusig/ewusr^2) * pmustar)/sigx6) *
      dwu * sqrt(sigma_sq) + sigx7^2 * ewz1/sigx2) * ewz1/sigx2),
    FUN = "*"), muHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    1):(nXvar + nmuZUvar + nuZUvar)] <- crossprod(sweep(muHvar,
    MARGIN = 1, STATS = wHvar * (((0.5 * (((2 - muepsi^2/(sigma_sq)) *
      pmustar + dmustar * ewv1 * muepsi/ssq) * dmusig *
      muepsi/(sigma_sq)^2) - ((sigx9 * ewv1/ssq^2 - sigx10 *
      muvu/(ewu * (sigma_sq))) * dmusig - sigx10 * dmusig *
      muepsi/(sigma_sq)) * dmustar)/(pwu * sqrt(sigma_sq)) -
      sigx11 * dwu * sqrt(sigma_sq)/sigx6) * ewu - ((((0.5 *
      (ewu/sqrt(sigma_sq)) - 0.5 * ((1 - mu^2/ewusr^2) *
      sqrt(sigma_sq))) * dmusig * dwu/ewusr - sigx12 *
      dmusig * muepsi/(sigma_sq)) * pmustar + sigx12 *
      (dmustar * ewv1/ssq - 2 * (dwu * (sigma_sq) * pmustar *
        pwu/sigx6)) * dmusig)/(pwu * sqrt(sigma_sq))^2 +
      sigx13 * sigx7 * ewz1/sigx2)) * ewz1/sigx2, FUN = "*"),
    uHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    nuZUvar + 1):(nXvar + nmuZUvar + nuZUvar + nvZVvar)] <- crossprod(sweep(muHvar,
    MARGIN = 1, STATS = wHvar * (((((1/ssq - (0.5 * (prV *
      ewu/sigmastar) + sigmastar) * ewv1/ssq^2) * dmusig -
      (dmusig * muvu/ewu + dmusig * muepsi) * sigx14/(sigma_sq)) *
      dmustar + 0.5 * (((2 - muepsi^2/(sigma_sq)) * pmustar +
      dmustar * ewv1 * muepsi/ssq) * dmusig * muepsi/(sigma_sq)^2) -
      sigx15 * dwu/(ewusr * pwu))/pwu - 0.5 * (((1 - 2 *
      ((sigma_sq) * pwu^2/(pwu * sqrt(sigma_sq))^2)) *
      dmusig * dwu * pmustar/ewusr + sigx5 * pwu/(sigma_sq))/(pwu *
      sqrt(sigma_sq))^2))/(sigx2 * sqrt(sigma_sq)) - (sigx15/pwu -
      0.5 * sigx16) * sigx7 * ewz1 * sqrt(sigma_sq)/(sigx2 *
      sqrt(sigma_sq))^2) * ewz1 * ewv1, FUN = "*"), vHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    nuZUvar + nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    2 * nvZVvar)] <- crossprod(sweep(muHvar, MARGIN = 1,
    STATS = -wHvar * (sigx7 * ewz2 * sigx17 * ewz1 * ewvsr2/(sigx2 *
      ewvsr2)^2), FUN = "*"), vHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    nuZUvar + 2 * nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    2 * nvZVvar + nZHvar)] <- crossprod(sweep(muHvar, MARGIN = 1,
    STATS = wHvar * sigx7 * (1/(pi * sigx2 * ((Wz)^2 + 1)) -
      pi * ((Wz)^2 + 1) * ewz1 * sigx18/(pi * sigx2 * ((Wz)^2 +
        1))^2), FUN = "*"), Zvar)
  hessll[(nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar),
    (nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = wHvar * ((((0.5 * (((0.5 * (muepsi^2/(sigma_sq)) -
      2) * pmustar/(sigma_sq) - sigx10 * dmustar) * ewu) +
      0.5 * pmustar) * dmusig * muepsi^2/(sigma_sq)^2 -
      ((sigx10^2 * ewu * muvu/ssq + ((0.5 * (ewu/(sigma_sq)) -
        0.5 * (0.5 * prU + ewu/(sigma_sq))) * prU * ewv1 *
        muvu/sigmastar - sigx9 * (2 * (sigx9 * (sigma_sq) *
        muvu * sigmastar/ssq^2) + 2 * (S * (epsilon))) *
        ewu)/ssq^2) * dmusig + sigx10 * (0.5 * (dmusig *
        ewu * muepsi^2/(sigma_sq)^2) + dmusig)) * dmustar)/(pwu *
      sqrt(sigma_sq)) - sigx11 * sigx12/(pwu * sqrt(sigma_sq))^2) *
      ewu - ((((0.5 * (((1 - 0.5 * (ewu/(sigma_sq))) *
      pwu - 0.5 * (mu * dwu/ewusr)) * ewu/sqrt(sigma_sq)) -
      0.5 * (mu * ((0.5 * (mu^2/ewusr^2) - 0.5) * sqrt(sigma_sq) +
        0.5 * (ewu/sqrt(sigma_sq))) * dwu/ewusr)) * dmusig +
      0.5 * (sigx12 * dmusig * ewu * muepsi^2/(sigma_sq)^2)) *
      pmustar - (sigx10 * dmustar * ewu + 2 * (sigx12 *
      pmustar * pwu * sqrt(sigma_sq)/(pwu * sqrt(sigma_sq))^2)) *
      sigx12 * dmusig)/(pwu * sqrt(sigma_sq))^2 + sigx13^2 *
      ewz1/sigx2)) * ewz1/sigx2, FUN = "*"), uHvar)
  hessll[(nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar),
    (nXvar + nmuZUvar + nuZUvar + 1):(nXvar + nmuZUvar +
      nuZUvar + nvZVvar)] <- crossprod(sweep(uHvar, MARGIN = 1,
    STATS = wHvar * ((((((sigx10 * dmusig * muvu/sigmastar +
  ...
  hessll[(nXvar + nmuZUvar + nuZUvar + 1):(nXvar + nmuZUvar +
    ...
    MARGIN = 1, STATS = -wHvar * ((sigx15/pwu - 0.5 * sigx16) *
      ewz2 * sigx17 * ewz1 * ewv1 * ewvsr2/((sigx2 * ewvsr2)^2 *
      sqrt(sigma_sq))), FUN = "*"), vHvar)
  hessll[(nXvar + nmuZUvar + nuZUvar + 1):(nXvar + nmuZUvar +
    nuZUvar + nvZVvar), (nXvar + nmuZUvar + nuZUvar + 2 *
    nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar + 2 * nvZVvar +
    nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = wHvar *
    (sigx15/pwu - 0.5 * sigx16) * (1/(pi * sigx2 * ((Wz)^2 +
    1)) - pi * ((Wz)^2 + 1) * ewz1 * sigx18/(pi * sigx2 *
    ((Wz)^2 + 1))^2) * ewv1/sqrt(sigma_sq), FUN = "*"), Zvar)
  hessll[(nXvar + nmuZUvar + nuZUvar + nvZVvar + 1):(nXvar +
    nmuZUvar + nuZUvar + 2 * nvZVvar), (nXvar + nmuZUvar +
    nuZUvar + nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    2 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = wHvar *
    ewz2 * (S^2 * (0.5 * (0.5 * (S^2 * (epsilon)^2/ewvsr2^2) -
  ...
  hessll[(nXvar + nmuZUvar + nuZUvar + nvZVvar + 1):(nXvar +
    ...
    nuZUvar + 2 * nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    2 * nvZVvar + nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1,
    STATS = -wHvar * (sigx17 * (1/(pi * sigx2 * ((Wz)^2 +
      1)) + pi * ((Wz)^2 + 1) * ewz2 * sigx18/(pi * sigx2 *
      ((Wz)^2 + 1))^2)/ewvsr2), FUN = "*"), Zvar)
  hessll[(nXvar + nmuZUvar + nuZUvar + 2 * nvZVvar + 1):(nXvar +
    nmuZUvar + nuZUvar + 2 * nvZVvar + nZHvar), (nXvar +
    nmuZUvar + nuZUvar + 2 * nvZVvar + 1):(nXvar + nmuZUvar +
    nuZUvar + 2 * nvZVvar + nZHvar)] <- crossprod(sweep(Zvar,
...
## probit specification class membership
chessmnsftruncnormlike_probit <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
  ...
  hessll[1:nXvar, (nXvar + nmuZUvar + nuZUvar + 1):(nXvar +
    ...
    MARGIN = 1, STATS = wHvar * S * (((((dmusig * muepsi -
      ...
      0.5 * (sigx1 * pwu/((sigma_sq) * (pwu * sqrt(sigma_sq))^2)))/(sigx2 *
      sqrt(sigma_sq)) - (sigx15/pwu - 0.5 * sigx16) * sigx4 *
      sqrt(sigma_sq)/(sigx2 * sqrt(sigma_sq))^2) * ewv1 *
      pwZ, FUN = "*"), vHvar)
  hessll[1:nXvar, (nXvar + nmuZUvar + nuZUvar + nvZVvar + 1):(nXvar +
    nmuZUvar + nuZUvar + 2 * nvZVvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = wHvar * S * (1 - pwZ) * (S * (0.5 *
      (S^2 * (epsilon)^2/ewvsr2^2 - 2) - 0.5) * depsi *
      (epsilon)/(sigx2 * ewvsr2^3) - sigx4 * sigx17 * ewvsr2/(sigx2 *
      ewvsr2)^2), FUN = "*"), vHvar)
  hessll[1:nXvar, (nXvar + nmuZUvar + nuZUvar + 2 * nvZVvar +
    1):(nXvar + nmuZUvar + nuZUvar + 2 * nvZVvar + nZHvar)] <- crossprod(sweep(Xvar,
  ...
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + 1):(nXvar +
    ...
    (((((1 - muepsi^2/(sigma_sq)) * pmustar + dmustar * ewv1 *
      ...
      (sigma_sq) + (dmustar * dmusig * ewv1/ssq - (dmusig *
      muepsi/(sigma_sq) + mu * dmusig/ewusr^2) * pmustar)/sigx6) *
      dwu * sqrt(sigma_sq) + sigx7^2 * pwZ/sigx2) * pwZ/sigx2),
    FUN = "*"), muHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    1):(nXvar + nmuZUvar + nuZUvar)] <- crossprod(sweep(muHvar,
    MARGIN = 1, STATS = wHvar * (((0.5 * (((2 - muepsi^2/(sigma_sq)) *
      ...
      (dmustar * ewv1/ssq - 2 * (dwu * (sigma_sq) * pmustar *
        pwu/sigx6)) * dmusig)/(pwu * sqrt(sigma_sq))^2 +
      sigx13 * sigx7 * pwZ/sigx2)) * pwZ/sigx2, FUN = "*"),
    uHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    nuZUvar + 1):(nXvar + nmuZUvar + nuZUvar + nvZVvar)] <- crossprod(sweep(muHvar,
    MARGIN = 1, STATS = wHvar * (((((1/ssq - (0.5 * (prV *
      ...
      dmusig * dwu * pmustar/ewusr + sigx5 * pwu/(sigma_sq))/(pwu *
      sqrt(sigma_sq))^2))/(sigx2 * sqrt(sigma_sq)) - (sigx15/pwu -
      0.5 * sigx16) * sigx7 * pwZ * sqrt(sigma_sq)/(sigx2 *
      sqrt(sigma_sq))^2) * ewv1 * pwZ, FUN = "*"), vHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    nuZUvar + nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    2 * nvZVvar)] <- crossprod(sweep(muHvar, MARGIN = 1,
    STATS = -wHvar * (sigx7 * sigx17 * (1 - pwZ) * ewvsr2 *
      pwZ/(sigx2 * ewvsr2)^2), FUN = "*"), vHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    nuZUvar + 2 * nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    2 * nvZVvar + nZHvar)] <- crossprod(sweep(muHvar, MARGIN = 1,
    STATS = wHvar * sigx7 * (1 - sigx18 * pwZ/sigx2) * dwZ/sigx2,
    FUN = "*"), Zvar)
  hessll[(nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar),
    (nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = wHvar * ((((0.5 * (((0.5 * (muepsi^2/(sigma_sq)) -
  ...
  hessll[(nXvar + nmuZUvar + nuZUvar + 1):(nXvar + nmuZUvar +
    ...
    1):(nXvar + nmuZUvar + nuZUvar + 2 * nvZVvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = -wHvar * ((sigx15/pwu - 0.5 * sigx16) *
      sigx17 * (1 - pwZ) * ewv1 * ewvsr2 * pwZ/((sigx2 *
      ewvsr2)^2 * sqrt(sigma_sq))), FUN = "*"), vHvar)
  hessll[(nXvar + nmuZUvar + nuZUvar + 1):(nXvar + nmuZUvar +
    nuZUvar + nvZVvar), (nXvar + nmuZUvar + nuZUvar + 2 *
    nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar + 2 * nvZVvar +
    nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = wHvar *
    (sigx15/pwu - 0.5 * sigx16) * (1 - sigx18 * pwZ/sigx2) *
    dwZ * ewv1/(sigx2 * sqrt(sigma_sq)), FUN = "*"), Zvar)
  hessll[(nXvar + nmuZUvar + nuZUvar + nvZVvar + 1):(nXvar +
    nmuZUvar + nuZUvar + 2 * nvZVvar), (nXvar + nmuZUvar +
    nuZUvar + nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    2 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = wHvar *
    (1 - pwZ) * (S^2 * (0.5 * (0.5 * (S^2 * (epsilon)^2/ewvsr2^2) -
    1) - 0.25) * depsi * (epsilon)^2/(sigx2 * ewvsr2^3) -
    (sigx17 * (1 - pwZ) + 0.5 * (sigx2 * ewvsr2)) * sigx17/(sigx2 *
      ewvsr2)^2), FUN = "*"), vHvar)
  hessll[(nXvar + nmuZUvar + nuZUvar + nvZVvar + 1):(nXvar +
    nmuZUvar + nuZUvar + 2 * nvZVvar), (nXvar + nmuZUvar +
    nuZUvar + 2 * nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    2 * nvZVvar + nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1,
    STATS = -wHvar * (((1 - pwZ) * sigx18/sigx2 + 1) * sigx17 *
      dwZ/(sigx2 * ewvsr2)), FUN = "*"), Zvar)
  hessll[(nXvar + nmuZUvar + nuZUvar + 2 * nvZVvar + 1):(nXvar +
    nmuZUvar + nuZUvar + 2 * nvZVvar + nZHvar), (nXvar +
    nmuZUvar + nuZUvar + 2 * nvZVvar + 1):(nXvar + nmuZUvar +
    nuZUvar + 2 * nvZVvar + nZHvar)] <- crossprod(sweep(Zvar,
...
## cloglog specification class membership
chessmnsftruncnormlike_cloglog <- function(parm, nXvar, nmuZUvar,
  nuZUvar, nvZVvar, muHvar, uHvar, vHvar, Yvar, Xvar, S, wHvar,
  Zvar, nZHvar) {
  beta <- parm[1:(nXvar)]
  omega <- parm[(nXvar + 1):(nXvar + nmuZUvar)]
  ...
  hessll[1:nXvar, (nXvar + 1):(nXvar + nmuZUvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = wHvar * S * (((dmustar * (dmusig *
      ...
      1) * pmustar + dmustar * ewu * muepsi/ssq) * dmusig)/(pwu *
      sqrt(sigma_sq)) - sigx1 * dwu * sqrt(sigma_sq)/sigx6)/(sigma_sq) -
      sigx4 * sigx7/sigx2) * (1 - prZ)/sigx2, FUN = "*"),
    muHvar)
  hessll[1:nXvar, (nXvar + nmuZUvar + 1):(nXvar + nmuZUvar +
    nuZUvar)] <- crossprod(sweep(Xvar, MARGIN = 1, STATS = wHvar *
    S * ((0.5 * (((muepsi^2/(sigma_sq) - 2) * pmustar + dmustar *
  ...
  hessll[1:nXvar, (nXvar + nmuZUvar + nuZUvar + 1):(nXvar +
    ...
    MARGIN = 1, STATS = wHvar * S * (((((dmusig * muepsi -
      ...
      0.5 * (sigx1 * pwu/((sigma_sq) * (pwu * sqrt(sigma_sq))^2)))/(sigx2 *
      sqrt(sigma_sq)) - (sigx15/pwu - 0.5 * sigx16) * sigx4 *
      sqrt(sigma_sq)/(sigx2 * sqrt(sigma_sq))^2) * (1 -
      prZ) * ewv1, FUN = "*"), vHvar)
  hessll[1:nXvar, (nXvar + nmuZUvar + nuZUvar + nvZVvar + 1):(nXvar +
    nmuZUvar + nuZUvar + 2 * nvZVvar)] <- crossprod(sweep(Xvar,
    MARGIN = 1, STATS = wHvar * S * prZ * (S * (0.5 * (S^2 *
      (epsilon)^2/ewvsr2^2 - 2) - 0.5) * depsi * (epsilon)/(sigx2 *
      ewvsr2^3) - sigx4 * sigx17 * ewvsr2/(sigx2 * ewvsr2)^2),
    FUN = "*"), vHvar)
  hessll[1:nXvar, (nXvar + nmuZUvar + nuZUvar + 2 * nvZVvar +
  ...
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + 1):(nXvar +
    ...
    (((((1 - muepsi^2/(sigma_sq)) * pmustar + dmustar * ewv1 *
      ...
      (sigma_sq) + (dmustar * dmusig * ewv1/ssq - (dmusig *
      muepsi/(sigma_sq) + mu * dmusig/ewusr^2) * pmustar)/sigx6) *
      dwu * sqrt(sigma_sq) + sigx7^2 * (1 - prZ)/sigx2) *
      (1 - prZ)/sigx2), FUN = "*"), muHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    1):(nXvar + nmuZUvar + nuZUvar)] <- crossprod(sweep(muHvar,
    MARGIN = 1, STATS = wHvar * (((0.5 * (((2 - muepsi^2/(sigma_sq)) *
      pmustar + dmustar * ewv1 * muepsi/ssq) * dmusig *
      ...
      (dmustar * ewv1/ssq - 2 * (dwu * (sigma_sq) * pmustar *
        pwu/sigx6)) * dmusig)/(pwu * sqrt(sigma_sq))^2 +
      sigx13 * sigx7 * (1 - prZ)/sigx2)) * (1 - prZ)/sigx2,
    FUN = "*"), uHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    nuZUvar + 1):(nXvar + nmuZUvar + nuZUvar + nvZVvar)] <- crossprod(sweep(muHvar,
    MARGIN = 1, STATS = wHvar * (((((1/ssq - (0.5 * (prV *
      ...
      dmusig * dwu * pmustar/ewusr + sigx5 * pwu/(sigma_sq))/(pwu *
      sqrt(sigma_sq))^2))/(sigx2 * sqrt(sigma_sq)) - (sigx15/pwu -
      0.5 * sigx16) * sigx7 * (1 - prZ) * sqrt(sigma_sq)/(sigx2 *
      sqrt(sigma_sq))^2) * (1 - prZ) * ewv1, FUN = "*"),
    vHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    nuZUvar + nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    2 * nvZVvar)] <- crossprod(sweep(muHvar, MARGIN = 1,
    STATS = -wHvar * (sigx7 * sigx17 * (1 - prZ) * prZ *
      ewvsr2/(sigx2 * ewvsr2)^2), FUN = "*"), vHvar)
  hessll[(nXvar + 1):(nXvar + nmuZUvar), (nXvar + nmuZUvar +
    nuZUvar + 2 * nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    2 * nvZVvar + nZHvar)] <- crossprod(sweep(muHvar, MARGIN = 1,
    STATS = wHvar * sigx7 * (1 - (1 - prZ) * sigx18/sigx2) *
      prZ * ewz/sigx2, FUN = "*"), Zvar)
  hessll[(nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar),
    (nXvar + nmuZUvar + 1):(nXvar + nmuZUvar + nuZUvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = wHvar * ((((0.5 * (((0.5 * (muepsi^2/(sigma_sq)) -
  ...
  hessll[(nXvar + nmuZUvar + nuZUvar + 1):(nXvar + nmuZUvar +
    ...
    1):(nXvar + nmuZUvar + nuZUvar + 2 * nvZVvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = -wHvar * ((sigx15/pwu - 0.5 * sigx16) *
      sigx17 * (1 - prZ) * prZ * ewv1 * ewvsr2/((sigx2 *
      ewvsr2)^2 * sqrt(sigma_sq))), FUN = "*"), vHvar)
  hessll[(nXvar + nmuZUvar + nuZUvar + 1):(nXvar + nmuZUvar +
    nuZUvar + nvZVvar), (nXvar + nmuZUvar + nuZUvar + 2 *
    nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar + 2 * nvZVvar +
    nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = wHvar *
    (sigx15/pwu - 0.5 * sigx16) * (1 - (1 - prZ) * sigx18/sigx2) *
    prZ * ewv1 * ewz/(sigx2 * sqrt(sigma_sq)), FUN = "*"),
    Zvar)
  hessll[(nXvar + nmuZUvar + nuZUvar + nvZVvar + 1):(nXvar +
    nmuZUvar + nuZUvar + 2 * nvZVvar), (nXvar + nmuZUvar +
    nuZUvar + nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    2 * nvZVvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = wHvar *
    prZ * (S^2 * (0.5 * (0.5 * (S^2 * (epsilon)^2/ewvsr2^2) -
    1) - 0.25) * depsi * (epsilon)^2/(sigx2 * ewvsr2^3) -
  ...
  hessll[(nXvar + nmuZUvar + nuZUvar + nvZVvar + 1):(nXvar +
    ...
    nuZUvar + 2 * nvZVvar + 1):(nXvar + nmuZUvar + nuZUvar +
    2 * nvZVvar + nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1,
    STATS = -wHvar * ((sigx18 * prZ/sigx2 + 1) * sigx17 *
      prZ * ewz/(sigx2 * ewvsr2)), FUN = "*"), Zvar)
  hessll[(nXvar + nmuZUvar + nuZUvar + 2 * nvZVvar + 1):(nXvar +
    nmuZUvar + nuZUvar + 2 * nvZVvar + nZHvar), (nXvar +
    nmuZUvar + nuZUvar + 2 * nvZVvar + 1):(nXvar + nmuZUvar +
    nuZUvar + 2 * nvZVvar + nZHvar)] <- crossprod(sweep(Zvar,
...
## logit specification class membership
zisftruncnormAlgOpt_logit <- function(start, olsParam, dataTable,
  ...
  startLoglik <- sum(czisftruncnormlike_logit(startVal, nXvar = nXvar,
  ...
  mleObj <- switch(method, ucminf = ucminf::ucminf(par = startVal,
    fn = function(parm) -sum(czisftruncnormlike_logit(parm,
      ...
      grtol = gradtol)), maxLikAlgo = maxRoutine(fn = czisftruncnormlike_logit,
    ...
    sparse = trustOptim::trust.optim(x = startVal, fn = function(parm) -sum(czisftruncnormlike_logit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradzisftruncnormlike_logit(parm,
    ...
    mla = marqLevAlg::mla(b = startVal, fn = function(parm) -sum(czisftruncnormlike_logit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradzisftruncnormlike_logit(parm,
    ...
    nlminb = nlminb(start = startVal, objective = function(parm) -sum(czisftruncnormlike_logit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
  ...
  if (method %in% c("ucminf", "nlminb")) {
    mleObj$gradient <- colSums(cgradzisftruncnormlike_logit(mleObj$par,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
  ...
  if (hessianType != 2) {
    if (method %in% c("ucminf", "nlminb"))
      mleObj$hessian <- chesszisftruncnormlike_logit(parm = mleObj$par,
        nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
        uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
        S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
        Zvar = Zvar, nZHvar = nZHvar)
  ...
  mleObj$logL_OBS <- czisftruncnormlike_logit(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
  mleObj$gradL_OBS <- cgradzisftruncnormlike_logit(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
...
## cauchit specification class membership
zisftruncnormAlgOpt_cauchit <- function(start, olsParam, dataTable,
  S, wHvar, nXvar, muHvar, nmuZUvar, uHvar, nuZUvar, vHvar,
  nvZVvar, Zvar, nZHvar, Yvar, Xvar, method, printInfo, itermax,
  stepmax, whichStart, initIter, initAlg, tol, gradtol, hessianType,
  qac) {
  ...
  initTrunc <- start_st$initTrunc
  startVal <- start_st$StartVal
  startLoglik <- sum(czisftruncnormlike_cauchit(startVal, nXvar = nXvar,
    nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar,
    vHvar = vHvar, Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar,
    muHvar = muHvar, nmuZUvar = nmuZUvar, Zvar = Zvar, nZHvar = nZHvar))
  if (method %in% c("bfgs", "bhhh", "nr", "nm", "cg", "sann")) {
  ...
  cat("ZISF Estimation...\n")
  mleObj <- switch(method, ucminf = ucminf::ucminf(par = startVal,
    fn = function(parm) -sum(czisftruncnormlike_cauchit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      ...
      Zvar = Zvar, nZHvar = nZHvar)), hessian = 0, control = list(trace = printInfo,
      maxeval = itermax, stepmax = stepmax, xtol = tol,
      grtol = gradtol)), maxLikAlgo = maxRoutine(fn = czisftruncnormlike_cauchit,
    ...
    fn = function(parm) -sum(czisftruncnormlike_cauchit(parm,
      ...
      cgtol = gradtol, stop.trust.radius = tol, prec = tol,
      report.level = if (printInfo) 4L else 0, report.precision = 1L)),
    sparse = trustOptim::trust.optim(x = startVal, fn = function(parm) -sum(czisftruncnormlike_cauchit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradzisftruncnormlike_cauchit(parm,
      ...
      control = list(maxit = itermax, cgtol = gradtol,
        stop.trust.radius = tol, prec = tol, report.level = if (printInfo) 4L else 0,
        report.precision = 1L, preconditioner = 1L)),
    mla = marqLevAlg::mla(b = startVal, fn = function(parm) -sum(czisftruncnormlike_cauchit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradzisftruncnormlike_cauchit(parm,
      ...
      Zvar = Zvar, nZHvar = nZHvar), print.info = printInfo,
      maxiter = itermax, epsa = gradtol, epsb = gradtol),
    nlminb = nlminb(start = startVal, objective = function(parm) -sum(czisftruncnormlike_cauchit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      ...
      x.tol = tol)))
  if (method %in% c("ucminf", "nlminb")) {
    mleObj$gradient <- colSums(cgradzisftruncnormlike_cauchit(mleObj$par,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar))
  ...
  if (hessianType != 2) {
    if (method %in% c("ucminf", "nlminb"))
      mleObj$hessian <- chesszisftruncnormlike_cauchit(parm = mleObj$par,
        nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
        uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
        S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
        Zvar = Zvar, nZHvar = nZHvar)
  ...
  mleObj$logL_OBS <- czisftruncnormlike_cauchit(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
  mleObj$gradL_OBS <- cgradzisftruncnormlike_cauchit(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
...
## probit specification class membership
zisftruncnormAlgOpt_probit <- function(start, olsParam, dataTable,
  S, wHvar, nXvar, muHvar, nmuZUvar, uHvar, nuZUvar, vHvar,
  nvZVvar, Zvar, nZHvar, Yvar, Xvar, method, printInfo, itermax,
  stepmax, whichStart, initIter, initAlg, tol, gradtol, hessianType,
  qac) {
  ...
  initTrunc <- start_st$initTrunc
  startVal <- start_st$StartVal
  startLoglik <- sum(czisftruncnormlike_probit(startVal, nXvar = nXvar,
    nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar,
    vHvar = vHvar, Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar,
    muHvar = muHvar, nmuZUvar = nmuZUvar, Zvar = Zvar, nZHvar = nZHvar))
  if (method %in% c("bfgs", "bhhh", "nr", "nm", "cg", "sann")) {
  ...
  cat("ZISF Estimation...\n")
  mleObj <- switch(method, ucminf = ucminf::ucminf(par = startVal,
    fn = function(parm) -sum(czisftruncnormlike_probit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      ...
      Zvar = Zvar, nZHvar = nZHvar)), hessian = 0, control = list(trace = printInfo,
      maxeval = itermax, stepmax = stepmax, xtol = tol,
      grtol = gradtol)), maxLikAlgo = maxRoutine(fn = czisftruncnormlike_probit,
    ...
    fn = function(parm) -sum(czisftruncnormlike_probit(parm,
      ...
      cgtol = gradtol, stop.trust.radius = tol, prec = tol,
      report.level = if (printInfo) 4L else 0, report.precision = 1L)),
    sparse = trustOptim::trust.optim(x = startVal, fn = function(parm) -sum(czisftruncnormlike_probit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradzisftruncnormlike_probit(parm,
      ...
      control = list(maxit = itermax, cgtol = gradtol,
        stop.trust.radius = tol, prec = tol, report.level = if (printInfo) 4L else 0,
        report.precision = 1L, preconditioner = 1L)),
    mla = marqLevAlg::mla(b = startVal, fn = function(parm) -sum(czisftruncnormlike_probit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradzisftruncnormlike_probit(parm,
      ...
      Zvar = Zvar, nZHvar = nZHvar), print.info = printInfo,
      maxiter = itermax, epsa = gradtol, epsb = gradtol),
    nlminb = nlminb(start = startVal, objective = function(parm) -sum(czisftruncnormlike_probit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      ...
      x.tol = tol)))
  if (method %in% c("ucminf", "nlminb")) {
    mleObj$gradient <- colSums(cgradzisftruncnormlike_probit(mleObj$par,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar))
  ...
  if (hessianType != 2) {
    if (method %in% c("ucminf", "nlminb"))
      mleObj$hessian <- chesszisftruncnormlike_probit(parm = mleObj$par,
        nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
        uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
        S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
        Zvar = Zvar, nZHvar = nZHvar)
  ...
  mleObj$logL_OBS <- czisftruncnormlike_probit(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
  mleObj$gradL_OBS <- cgradzisftruncnormlike_probit(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
...
## cloglog specification class membership
zisftruncnormAlgOpt_cloglog <- function(start, olsParam, dataTable,
  S, wHvar, nXvar, muHvar, nmuZUvar, uHvar, nuZUvar, vHvar,
  nvZVvar, Zvar, nZHvar, Yvar, Xvar, method, printInfo, itermax,
  stepmax, whichStart, initIter, initAlg, tol, gradtol, hessianType,
  qac) {
  ...
  initTrunc <- start_st$initTrunc
  startVal <- start_st$StartVal
  startLoglik <- sum(czisftruncnormlike_cloglog(startVal, nXvar = nXvar,
    nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar,
    vHvar = vHvar, Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar,
    muHvar = muHvar, nmuZUvar = nmuZUvar, Zvar = Zvar, nZHvar = nZHvar))
  if (method %in% c("bfgs", "bhhh", "nr", "nm", "cg", "sann")) {
  ...
  cat("ZISF Estimation...\n")
  mleObj <- switch(method, ucminf = ucminf::ucminf(par = startVal,
    fn = function(parm) -sum(czisftruncnormlike_cloglog(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      ...
      Zvar = Zvar, nZHvar = nZHvar)), hessian = 0, control = list(trace = printInfo,
      maxeval = itermax, stepmax = stepmax, xtol = tol,
      grtol = gradtol)), maxLikAlgo = maxRoutine(fn = czisftruncnormlike_cloglog,
    ...
    fn = function(parm) -sum(czisftruncnormlike_cloglog(parm,
      ...
      cgtol = gradtol, stop.trust.radius = tol, prec = tol,
      report.level = if (printInfo) 4L else 0, report.precision = 1L)),
    sparse = trustOptim::trust.optim(x = startVal, fn = function(parm) -sum(czisftruncnormlike_cloglog(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradzisftruncnormlike_cloglog(parm,
      ...
      control = list(maxit = itermax, cgtol = gradtol,
        stop.trust.radius = tol, prec = tol, report.level = if (printInfo) 4L else 0,
        report.precision = 1L, preconditioner = 1L)),
    mla = marqLevAlg::mla(b = startVal, fn = function(parm) -sum(czisftruncnormlike_cloglog(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradzisftruncnormlike_cloglog(parm,
      ...
      Zvar = Zvar, nZHvar = nZHvar), print.info = printInfo,
      maxiter = itermax, epsa = gradtol, epsb = gradtol),
    nlminb = nlminb(start = startVal, objective = function(parm) -sum(czisftruncnormlike_cloglog(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      ...
      x.tol = tol)))
  if (method %in% c("ucminf", "nlminb")) {
    mleObj$gradient <- colSums(cgradzisftruncnormlike_cloglog(mleObj$par,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar))
  ...
  if (hessianType != 2) {
    if (method %in% c("ucminf", "nlminb"))
      mleObj$hessian <- chesszisftruncnormlike_cloglog(parm = mleObj$par,
        nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
        uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
        S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
        Zvar = Zvar, nZHvar = nZHvar)
  ...
  mleObj$logL_OBS <- czisftruncnormlike_cloglog(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
  mleObj$gradL_OBS <- cgradzisftruncnormlike_cloglog(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
...
## logit specification class membership
mnsftruncnormAlgOpt_logit <- function(start, olsParam, dataTable,
  S, wHvar, nXvar, muHvar, nmuZUvar, uHvar, nuZUvar, vHvar,
  nvZVvar, Zvar, nZHvar, Yvar, Xvar, method, printInfo, itermax,
  stepmax, whichStart, initIter, initAlg, tol, gradtol, hessianType,
  qac) {
  ...
  initTrunc <- start_st$initTrunc
  startVal <- start_st$StartVal
  startLoglik <- sum(cmnsftruncnormlike_logit(startVal, nXvar = nXvar,
    nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar,
    vHvar = vHvar, Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar,
    muHvar = muHvar, nmuZUvar = nmuZUvar, Zvar = Zvar, nZHvar = nZHvar))
  if (method %in% c("bfgs", "bhhh", "nr", "nm", "cg", "sann")) {
  ...
  cat("ZISF Estimation...\n")
  mleObj <- switch(method, ucminf = ucminf::ucminf(par = startVal,
    fn = function(parm) -sum(cmnsftruncnormlike_logit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      ...
      Zvar = Zvar, nZHvar = nZHvar)), hessian = 0, control = list(trace = printInfo,
      maxeval = itermax, stepmax = stepmax, xtol = tol,
      grtol = gradtol)), maxLikAlgo = maxRoutine(fn = cmnsftruncnormlike_logit,
    ...
    fn = function(parm) -sum(cmnsftruncnormlike_logit(parm,
      ...
      cgtol = gradtol, stop.trust.radius = tol, prec = tol,
      report.level = if (printInfo) 4L else 0, report.precision = 1L)),
    sparse = trustOptim::trust.optim(x = startVal, fn = function(parm) -sum(cmnsftruncnormlike_logit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradmnsftruncnormlike_logit(parm,
      ...
      control = list(maxit = itermax, cgtol = gradtol,
        stop.trust.radius = tol, prec = tol, report.level = if (printInfo) 4L else 0,
        report.precision = 1L, preconditioner = 1L)),
    mla = marqLevAlg::mla(b = startVal, fn = function(parm) -sum(cmnsftruncnormlike_logit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradmnsftruncnormlike_logit(parm,
      ...
      Zvar = Zvar, nZHvar = nZHvar), print.info = printInfo,
      maxiter = itermax, epsa = gradtol, epsb = gradtol),
    nlminb = nlminb(start = startVal, objective = function(parm) -sum(cmnsftruncnormlike_logit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      ...
      x.tol = tol)))
  if (method %in% c("ucminf", "nlminb")) {
    mleObj$gradient <- colSums(cgradmnsftruncnormlike_logit(mleObj$par,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar))
  ...
  if (hessianType != 2) {
    if (method %in% c("ucminf", "nlminb"))
      mleObj$hessian <- chessmnsftruncnormlike_logit(parm = mleObj$par,
        nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
        uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
        S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
        Zvar = Zvar, nZHvar = nZHvar)
  ...
  mleObj$logL_OBS <- cmnsftruncnormlike_logit(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
  mleObj$gradL_OBS <- cgradmnsftruncnormlike_logit(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
...
## cauchit specification class membership
mnsftruncnormAlgOpt_cauchit <- function(start, olsParam, dataTable,
  S, wHvar, nXvar, muHvar, nmuZUvar, uHvar, nuZUvar, vHvar,
  nvZVvar, Zvar, nZHvar, Yvar, Xvar, method, printInfo, itermax,
  stepmax, whichStart, initIter, initAlg, tol, gradtol, hessianType,
  qac) {
  ...
  initTrunc <- start_st$initTrunc
  startVal <- start_st$StartVal
  startLoglik <- sum(cmnsftruncnormlike_cauchit(startVal, nXvar = nXvar,
    nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar,
    vHvar = vHvar, Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar,
    muHvar = muHvar, nmuZUvar = nmuZUvar, Zvar = Zvar, nZHvar = nZHvar))
  if (method %in% c("bfgs", "bhhh", "nr", "nm", "cg", "sann")) {
  ...
  cat("ZISF Estimation...\n")
  mleObj <- switch(method, ucminf = ucminf::ucminf(par = startVal,
    fn = function(parm) -sum(cmnsftruncnormlike_cauchit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      ...
      Zvar = Zvar, nZHvar = nZHvar)), hessian = 0, control = list(trace = printInfo,
      maxeval = itermax, stepmax = stepmax, xtol = tol,
      grtol = gradtol)), maxLikAlgo = maxRoutine(fn = cmnsftruncnormlike_cauchit,
    ...
    fn = function(parm) -sum(cmnsftruncnormlike_cauchit(parm,
      ...
      cgtol = gradtol, stop.trust.radius = tol, prec = tol,
      report.level = if (printInfo) 4L else 0, report.precision = 1L)),
    sparse = trustOptim::trust.optim(x = startVal, fn = function(parm) -sum(cmnsftruncnormlike_cauchit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradmnsftruncnormlike_cauchit(parm,
      ...
      control = list(maxit = itermax, cgtol = gradtol,
        stop.trust.radius = tol, prec = tol, report.level = if (printInfo) 4L else 0,
        report.precision = 1L, preconditioner = 1L)),
    mla = marqLevAlg::mla(b = startVal, fn = function(parm) -sum(cmnsftruncnormlike_cauchit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradmnsftruncnormlike_cauchit(parm,
      ...
      Zvar = Zvar, nZHvar = nZHvar), print.info = printInfo,
      maxiter = itermax, epsa = gradtol, epsb = gradtol),
    nlminb = nlminb(start = startVal, objective = function(parm) -sum(cmnsftruncnormlike_cauchit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      ...
      x.tol = tol)))
  if (method %in% c("ucminf", "nlminb")) {
    mleObj$gradient <- colSums(cgradmnsftruncnormlike_cauchit(mleObj$par,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar))
  ...
  if (hessianType != 2) {
    if (method %in% c("ucminf", "nlminb"))
      mleObj$hessian <- chessmnsftruncnormlike_cauchit(parm = mleObj$par,
        nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
        uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
        S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
        Zvar = Zvar, nZHvar = nZHvar)
  ...
  mleObj$logL_OBS <- cmnsftruncnormlike_cauchit(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
  mleObj$gradL_OBS <- cgradmnsftruncnormlike_cauchit(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
...
## probit specification class membership
mnsftruncnormAlgOpt_probit <- function(start, olsParam, dataTable,
  S, wHvar, nXvar, muHvar, nmuZUvar, uHvar, nuZUvar, vHvar,
  nvZVvar, Zvar, nZHvar, Yvar, Xvar, method, printInfo, itermax,
  stepmax, whichStart, initIter, initAlg, tol, gradtol, hessianType,
  qac) {
  ...
  initTrunc <- start_st$initTrunc
  startVal <- start_st$StartVal
  startLoglik <- sum(cmnsftruncnormlike_probit(startVal, nXvar = nXvar,
    nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar,
    vHvar = vHvar, Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar,
    muHvar = muHvar, nmuZUvar = nmuZUvar, Zvar = Zvar, nZHvar = nZHvar))
  if (method %in% c("bfgs", "bhhh", "nr", "nm", "cg", "sann")) {
  ...
  cat("ZISF Estimation...\n")
  mleObj <- switch(method, ucminf = ucminf::ucminf(par = startVal,
    fn = function(parm) -sum(cmnsftruncnormlike_probit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      ...
      Zvar = Zvar, nZHvar = nZHvar)), hessian = 0, control = list(trace = printInfo,
      maxeval = itermax, stepmax = stepmax, xtol = tol,
      grtol = gradtol)), maxLikAlgo = maxRoutine(fn = cmnsftruncnormlike_probit,
    ...
    fn = function(parm) -sum(cmnsftruncnormlike_probit(parm,
      ...
      cgtol = gradtol, stop.trust.radius = tol, prec = tol,
      report.level = if (printInfo) 4L else 0, report.precision = 1L)),
    sparse = trustOptim::trust.optim(x = startVal, fn = function(parm) -sum(cmnsftruncnormlike_probit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradmnsftruncnormlike_probit(parm,
      ...
      control = list(maxit = itermax, cgtol = gradtol,
        stop.trust.radius = tol, prec = tol, report.level = if (printInfo) 4L else 0,
        report.precision = 1L, preconditioner = 1L)),
    mla = marqLevAlg::mla(b = startVal, fn = function(parm) -sum(cmnsftruncnormlike_probit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradmnsftruncnormlike_probit(parm,
      ...
      Zvar = Zvar, nZHvar = nZHvar), print.info = printInfo,
      maxiter = itermax, epsa = gradtol, epsb = gradtol),
    nlminb = nlminb(start = startVal, objective = function(parm) -sum(cmnsftruncnormlike_probit(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      ...
      x.tol = tol)))
  if (method %in% c("ucminf", "nlminb")) {
    mleObj$gradient <- colSums(cgradmnsftruncnormlike_probit(mleObj$par,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar))
  ...
  if (hessianType != 2) {
    if (method %in% c("ucminf", "nlminb"))
      mleObj$hessian <- chessmnsftruncnormlike_probit(parm = mleObj$par,
        nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
        uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
        S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
        Zvar = Zvar, nZHvar = nZHvar)
  ...
  mleObj$logL_OBS <- cmnsftruncnormlike_probit(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
  mleObj$gradL_OBS <- cgradmnsftruncnormlike_probit(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
...
## cloglog specification class membership
mnsftruncnormAlgOpt_cloglog <- function(start, olsParam, dataTable,
  S, wHvar, nXvar, muHvar, nmuZUvar, uHvar, nuZUvar, vHvar,
  nvZVvar, Zvar, nZHvar, Yvar, Xvar, method, printInfo, itermax,
  stepmax, whichStart, initIter, initAlg, tol, gradtol, hessianType,
  qac) {
  start_st <- if (!is.null(start))
    ...
    Zvar = Zvar, nZHvar = nZHvar, uHvar = uHvar, nuZUvar = nuZUvar,
    vHvar = vHvar, nvZVvar = nvZVvar, nXvar = nXvar, Xvar = Xvar,
    Yvar = Yvar, printInfo = printInfo, tol = tol)
  initTrunc <- start_st$initTrunc
  startVal <- start_st$StartVal
  startLoglik <- sum(cmnsftruncnormlike_cloglog(startVal, nXvar = nXvar,
    nuZUvar = nuZUvar, nvZVvar = nvZVvar, uHvar = uHvar,
    vHvar = vHvar, Yvar = Yvar, Xvar = Xvar, S = S, wHvar = wHvar,
    muHvar = muHvar, nmuZUvar = nmuZUvar, Zvar = Zvar, nZHvar = nZHvar))
  if (method %in% c("bfgs", "bhhh", "nr", "nm", "cg", "sann")) {
  ...
  cat("ZISF Estimation...\n")
  mleObj <- switch(method, ucminf = ucminf::ucminf(par = startVal,
    fn = function(parm) -sum(cmnsftruncnormlike_cloglog(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      ...
      Zvar = Zvar, nZHvar = nZHvar)), hessian = 0, control = list(trace = printInfo,
      maxeval = itermax, stepmax = stepmax, xtol = tol,
      grtol = gradtol)), maxLikAlgo = maxRoutine(fn = cmnsftruncnormlike_cloglog,
    ...
    fn = function(parm) -sum(cmnsftruncnormlike_cloglog(parm,
      ...
      cgtol = gradtol, stop.trust.radius = tol, prec = tol,
      report.level = if (printInfo) 4L else 0, report.precision = 1L)),
    sparse = trustOptim::trust.optim(x = startVal, fn = function(parm) -sum(cmnsftruncnormlike_cloglog(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradmnsftruncnormlike_cloglog(parm,
      ...
      control = list(maxit = itermax, cgtol = gradtol,
        stop.trust.radius = tol, prec = tol, report.level = if (printInfo) 4L else 0,
        report.precision = 1L, preconditioner = 1L)),
    mla = marqLevAlg::mla(b = startVal, fn = function(parm) -sum(cmnsftruncnormlike_cloglog(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar)), gr = function(parm) -colSums(cgradmnsftruncnormlike_cloglog(parm,
      ...
      Zvar = Zvar, nZHvar = nZHvar), print.info = printInfo,
      maxiter = itermax, epsa = gradtol, epsb = gradtol),
    nlminb = nlminb(start = startVal, objective = function(parm) -sum(cmnsftruncnormlike_cloglog(parm,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      ...
      x.tol = tol)))
  if (method %in% c("ucminf", "nlminb")) {
    mleObj$gradient <- colSums(cgradmnsftruncnormlike_cloglog(mleObj$par,
      nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
      uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
      S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
      Zvar = Zvar, nZHvar = nZHvar))
  ...
  if (hessianType != 2) {
    if (method %in% c("ucminf", "nlminb"))
      mleObj$hessian <- chessmnsftruncnormlike_cloglog(parm = mleObj$par,
        nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
        uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
        S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
        Zvar = Zvar, nZHvar = nZHvar)
  ...
  mleObj$logL_OBS <- cmnsftruncnormlike_cloglog(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
  mleObj$gradL_OBS <- cgradmnsftruncnormlike_cloglog(parm = mlParam,
    nXvar = nXvar, nuZUvar = nuZUvar, nvZVvar = nvZVvar,
    uHvar = uHvar, vHvar = vHvar, Yvar = Yvar, Xvar = Xvar,
    S = S, wHvar = wHvar, muHvar = muHvar, nmuZUvar = nmuZUvar,
    Zvar = Zvar, nZHvar = nZHvar)
