...
$$\int_0^\infty u \phi\left[\frac{u}{\sigma_v} -b\right]=\sigma_v^2\left[
...
Using all the previous developments,
...
Following previous developments, we have:
...
$$\int_0^\infty \exp{\left(-u\right)} \phi\left[\frac{u}{\sigma_v} -b\right]=
...
In terms of the reciprocal, again following previous developments, we have:
