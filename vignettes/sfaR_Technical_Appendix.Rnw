...
$$a = -\frac{S\epsilon}{\sigma_v}-\frac{\sigma_v}{\sigma_u}$$

and

$$b = -\frac{S\epsilon}{\sigma_v}- \frac{2\sigma_v}{\sigma_u}$$

\subsubsection{Technical (in)efficiencies derivation} \label{subsubsec:techineffgenexp}

\begin{align*}
f(u|\epsilon) & =\frac{f(u, \epsilon)}{f(\epsilon)} \\
& = \frac{\frac{1}{\sigma_v}\exp{(A)}\phi\left[\frac{u}{\sigma_v} - a\right]-
\frac{1}{\sigma_v}\exp{(B)}\phi\left[\frac{u}{\sigma_v} - b\right]}{\exp{
\left(A\right)}\Phi \left(a\right)-\exp{\left(B\right)}\Phi\left(b\right)}
\end{align*}
...
\phi\left[\frac{u}{\sigma_v} - a\right]du - \exp{(B)}\int_0^\infty\frac{u}{
\sigma_v}\phi\left[\frac{u}{\sigma_v} - b\right]du}{\exp{\left(A\right)}\Phi
\left(a\right)-\exp{\left(B\right)}\Phi\left(b\right)}$$

From the useful integrals in \ref{eq.a3}, we have

We have 

$$\int_0^\infty u \phi\left[\frac{u}{\sigma_v} -a\right]du = \sigma_v^2\left[
\phi\left(a\right) + a\Phi\left(a\right)\right]$$

and 

$$\int_0^\infty u \phi\left[\frac{u}{\sigma_v} -b\right]du=\sigma_v^2\left[
\phi\left(b\right)+b\Phi\left(b\right)\right]$$

Then

\begin{equation}\label{eq:1.7.2}
E\left[u|\epsilon\right] = \sigma_v \frac{\exp{\left(A\right)}\left[\phi\left(
a\right) + a\Phi\left(a\right)\right]- \exp{\left(B\right)}\left[\phi\left(
b\right)+b\Phi\left(b\right)\right]}{\exp{\left(A\right)}\Phi\left(a\right)-
\exp{\left(B\right)}\Phi\left(b\right)}
\end{equation}
...
\left(-a\sigma_v+\frac{\sigma_v^2}{2}\right)}\Phi\left(a-\sigma_v\right)-\exp{
\left(B\right)}\exp{\left(-b\sigma_v+\frac{\sigma_v^2}{2}\right)}\Phi\left(
b-\sigma_v\right)}{\exp{\left(A\right)}\Phi\left(a\right)-\exp{\left(B\right)}
\Phi\left(b\right)}
\end{equation}
...
$$a = -\frac{\sigma_v}{\sigma_u}-\frac{S\epsilon}{\sigma_v}$$

and

$$b = -\frac{\left(1+\lambda\right)\sigma_v}{\sigma_u}-\frac{S\epsilon}{\sigma_v}$$
...
\phi\left[\frac{u}{\sigma_v} - a\right]- \exp{\left(B\right)}\phi\left[
\frac{u}{\sigma_v} - b\right]}{\sigma_v\left[2\exp{\left(A\right)}
\Phi\left(a\right)-\exp{\left(B\right)}\Phi\left(b\right)\right]}$$

Using the integral in \ref{eq.a3}, we have

\begin{equation}\label{eq:1.8.2}
E\left[u|\epsilon\right] = \sigma_v \frac{2\exp{\left(A\right)}\left[
\phi\left(a\right) + a\Phi\left(a\right)\right]- \exp{\left(B\right)}\left[
\phi\left(b\right)+b\Phi\left(b\right)\right]}{2\exp{\left(A\right)}
\Phi\left(a\right)-\exp{\left(B\right)}\Phi\left(b\right)}
\end{equation}
...
$$\int_0^\infty \exp{\left(-u\right)} \phi\left[\frac{u}{\sigma_v} -a\right]du =
\sigma_v\exp{\left(-a\sigma_v+\frac{\sigma_v^2}{2}\right)}\Phi\left(a-
\sigma_v\right) $$

and 

$$\int_0^\infty \exp{\left(-u\right)} \phi\left[\frac{u}{\sigma_v} -b\right]du=
\sigma_v\exp{\left(-b\sigma_v+\frac{\sigma_v^2}{2}\right)}\Phi\left(b-
\sigma_v\right)$$
...
\left(-a\sigma_v+\frac{\sigma_v^2}{2}\right)}\Phi\left(a-\sigma_v\right)-\exp{
\left(B\right)}\exp{\left(-b\sigma_v+\frac{\sigma_v^2}{2}\right)}\Phi\left(b-
\sigma_v\right)}{2\exp{\left(A\right)}\Phi\left(a\right)-\exp{\left(B\right)}
\Phi\left(b\right)}
\end{equation}
...
\exp{\left(A\right)}\Phi\left(a\right) - 
\exp{\left(B\right)}\Phi\left(b\right)\right\}
\end{equation}
...
$$b = -\left(1+\alpha\right)\frac{\sigma_v}{\sigma_u} - 
\frac{S\epsilon}{\sigma_v}$$
...
\sqrt{2\pi}}\exp{\left(-\frac{1}{2\sigma_v^2}\left[u-\sigma_v a\right]^2\right)} 
- \frac{\alpha+1}{\alpha}\frac{\exp{\left(B\right)}}{\sigma_u\sigma_v
\sqrt{2\pi}}\exp{\left(-\frac{1}{2\sigma_v^2}\left[u-\sigma_v b\right]^2
\right)}}{\frac{\alpha + 1}{\alpha}\frac{1}{\sigma_u}\left\{
\exp{\left(A\right)}\Phi\left(a\right) - 
\exp{\left(B\right)}\Phi\left(b\right)\right\}} \\
 &=\frac{
    \frac{\exp{\left(A\right)}}{\sigma_v\sqrt{2\pi}} \exp\left(-\frac{1}{
    2\sigma_v^2} \left[u - \sigma_v a\right]^2 \right) 
    - \frac{\exp{\left(B\right)}}{\sigma_v\sqrt{2\pi}} \exp\left(-\frac{1}{
    2\sigma_v^2} \left[u - \sigma_v b\right]^2 \right)
}{\exp{\left(A\right)} \Phi\left(a\right) - \exp{\left(B\right)} 
\Phi\left(b\right)
}
\end{align*}
...
To obtain the conditional inefficiency, we need to solve two integrals. 
The first one is

$$I_1 = \int_0^\infty \frac{1}{\sigma_v\sqrt{2\pi}} u 
\exp\left(-\frac{1}{2\sigma_v^2} \left[u - \sigma_v a\right]^2 \right)du$$

and the second one is

$$I_2 = \int_0^\infty \frac{1}{\sigma_v\sqrt{2\pi}} u 
\exp\left(-\frac{1}{2\sigma_v^2} \left[u - \sigma_v b\right]^2 \right)du$$

Using the integral in \ref{eq.a3}, we have:

$$I_1 = \sigma_v\phi\left(a\right) + \sigma_v a\Phi\left(a\right)$$

and 

$$I_2 = \sigma_v\phi\left(b\right) +\sigma_v b\Phi\left(b\right)$$

Then

\begin{equation}\label{eq:1.11.2}
E\left[u|\epsilon\right] = \sigma_v\frac{
\exp{\left(A\right)}\left\{\phi\left(a\right) + a\Phi\left(a\right)\right\} - 
\exp\left(B\right)\left\{\phi\left(b\right) + b\Phi\left(b\right) \right\}}{
\exp{\left(A\right)}\Phi\left(a\right) - \exp\left(B\right)\Phi\left(b\right)} 
\end{equation}

The conditional efficiency and its reciprocal can be obtained by solving the 
following two integrals:

$$I_1 = \int_0^\infty \frac{1}{\sigma_v\sqrt{2\pi}} \exp\left(-tu -
\frac{1}{2\sigma_v^2} \left[u - \sigma_v a\right]^2 \right)du$$

and 

$$I_2 = \int_0^\infty \frac{1}{\sigma_v\sqrt{2\pi}} \exp\left(-tu -
\frac{1}{2\sigma_v^2} \left[u - \sigma_v b\right]^2 \right)du$$

Using the integral in \ref{eq.a4}, we have:

We have

$$I_1 = \exp{\left(-t\sigma_v a + \frac{1}{2}t^2\sigma_v^2\right)}
\Phi\left(a - t\sigma_v\right)$$

and

$$I_2 =\exp{\left(-t\sigma_v b + \frac{1}{2}t^2\sigma_v^2\right)}
\Phi\left(b - t\sigma_v\right)$$

\begin{itemize}
\item Conditional efficiency
\end{itemize}

The conditional efficiency is obtained by setting $t=1$, which yields

\begin{equation}\label{eq:1.11.3}
E\left[\exp{\left(-u\right)|\epsilon}\right]\frac{
\exp{\left(A\right)}\exp{\left(-\sigma_v a + \frac{1}{2}\sigma_v^2\right)}
\Phi\left(a - \sigma_v\right) - 
\exp\left(B\right)\exp{\left(-\sigma_v b + \frac{1}{2}\sigma_v^2\right)}
\Phi\left(b - \sigma_v\right)}{
\exp{\left(A\right)}\Phi\left(a\right) - \exp\left(B\right)\Phi\left(b\right)} 
\end{equation}
...
The reciprocal conditional efficiency is obtained by setting $t=-1$, which yields
