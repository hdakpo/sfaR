...
dkum14 <- as.data.frame(rbind(c(apply(hlfeff, 2, mean), apply(hlfmarg, 2, mean)), 
                ...
                c(apply(rayeff, 2, mean), apply(raymarg, 2, mean)), 
                c(apply(geeff, 2, mean), apply(gemarg, 2, mean)), 
                c(apply(ga2eff, 2, mean), apply(ga2marg, 2, mean)), 
                c(apply(weeff, 2, mean), apply(wemarg, 2, mean)), 
                c(apply(lgeff, 2, mean), apply(lgmarg, 2, mean)), 
                c(apply(tsleff, 2, mean), apply(tslmarg, 2, mean)), 
                c(apply(unieff, 2, mean), apply(unimarg, 2, mean))))
