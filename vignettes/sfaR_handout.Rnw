...
lcm <- sfalcmcross(formula = ly ~ lk + ll + yr,data = worldprod, 
                   lcmClasses = 2, printInfo = T)
gzisf <- sfagzisfcross(formula = ly ~ lk + ll + yr,data = worldprod, 
                   gzisfClasses = 2, printInfo = T)
cnsf <- sfalcmcross(formula = ly ~ lk + ll + yr,data = worldprod, 
                   printInfo = T)
...
pl81h <- sfapanel1(formula = LNCT ~ LNQ2 + LNQ3 + LNNET + LNPK + LNPL + 
  factor(YEAR), modelType = "pl81", idVar = "ID", timeVar = "YEAR", S = -1, 
  data = swissrailways)
...
k90 <- sfapanel1(formula = LNCT ~ LNQ2 + LNQ3 + LNNET + LNPK + LNPL +
  factor(YEAR), modelType = "k90", idVar = "ID", timeVar = "YEAR", S = -1, 
  data = swissrailways)
bc92a <- sfapanel1(formula = LNCT ~ LNQ2 + LNQ3 + LNNET + LNPK + LNPL + 
  factor(YEAR), modelType = "bc92a", idVar = "ID", timeVar = "YEAR", S = -1, 
  data = swissrailways)
